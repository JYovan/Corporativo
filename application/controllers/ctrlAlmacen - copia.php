...
//                }
    ...
    public function getReporteDePerdidas() {
        try {
            ...
            $pdf->SetY($Y);
            $pdf->SetX($space += 30);
            $pdf->Cell(40, 5, 'PROYECTO', 0, 0, 'L');
            $pdf->SetY($Y);
            $pdf->SetX($space += 35);
            $pdf->Cell(30, 5, 'ALMACEN', 0, 0, 'L');
            $pdf->SetY($Y);
            $pdf->SetX($space += 30);
            ...
            $pdf->SetY($Y);
            $pdf->SetX($X += 20);
            $pdf->Cell(15, 5, 'DESCRIPCIÓN DE LA PERDIDA', 0, 0, 'L');
            $pdf->SetY($Y);
            $pdf->SetX($X += 20);
            ...
            foreach ($rows as $k => $v) {
                ...
                $pdf->SetX(15);
                $pdf->MultiCell(25, 3, ($v->FECHA) . " " . $v->HORA);
                $pdf->SetY($Y);
                $pdf->SetX(50);
                $pdf->MultiCell(45, 5, ($v->PROYECTO));
                $pdf->SetY($Y);
                $pdf->SetX(80);
                $pdf->MultiCell(45, 5, ($v->ALMACEN));
                $pdf->SetY($Y);
                $pdf->SetX(110);
                $pdf->MultiCell(50, 5, ($v->PRODUCTO));
                $Y = $pdf->GetY();
            }
