...
//            print 1;
    ...
    public function onUpdateContrato() {
        try {
            ...
            print "\n\n\n";
            $data = array(
                'ContratoDeObra' => strtoupper($E["ContratoDeObra"]),
                'Contratante' => ((isset($E["Contratante"]) && $E["Contratante"] !== '' && $E["Contratante"] !== NULL) ? $E["Contratante"] : NULL),
                'Contratista' => ((isset($E["Contratista"]) && $E["Contratista"] !== '' && $E["Contratista"] !== NULL) ? $E["Contratista"] : NULL),
                ...
                'IVA' => ((isset($E["SubTotalContrato"]) && $E["SubTotalContrato"] !== '' && $E["SubTotalContrato"] !== NULL) ? (($E["SinIVA"] == false || $E["SinIVA"] == "false") ? ($E["SubTotalContrato"] * 0.16) : 0.0) : 0.0),
                'TotalContrato' => ((isset($E["SubTotalContrato"]) && $E["SubTotalContrato"] !== '' && $E["SubTotalContrato"] !== NULL) ? (($E["SinIVA"] == false || $E["SinIVA"] == "false") ? ($E["SubTotalContrato"] * 1.16) : $E["SubTotalContrato"]) : 0.0),
                'Saldo' => ((isset($E["SubTotalContrato"]) && $E["SubTotalContrato"] !== '' && $E["SubTotalContrato"] !== NULL) ? (($E["SinIVA"] == false || $E["SinIVA"] == "false") ? ($E["SubTotalContrato"] * 1.16) : $E["SubTotalContrato"]) : 0.0),
                ...
                'Registro' => Date('d/m/Y h:i:s a'),
                'RepresentanteContratante' => strtoupper(($E["RepresentanteContratante"] !== '' && $E["RepresentanteContratante"] !== NULL) ? $E["RepresentanteContratante"] : NULL),
                'RepresentanteContratista' => strtoupper(($E["RepresentanteContratista"] !== '' && $E["RepresentanteContratista"] !== NULL) ? $E["RepresentanteContratista"] : NULL),
            );
