...
<?php echo form_open_multipart('controlador/SS_4'); ?> 
                ...
                <table width="100%">
                    <tr>
                        <td bgcolor="#ff6600" align="center">
                            <strong style="color:#FFF">Generar constancia de autorizaciones y suspensiones ante el IMSS</strong>
                        </td>
                    </tr>  
                    <tr>
                        <td>
                        ...
                        <td  bgcolor="#99A79A">
                            <div class="col-xs-12 col-sm-12">
                                <label for="DatosL" class="control-label">
                                    Estado del trámite de generar constancia de autorizaciones y suspensiones ante el IMSS
                                </label><br>		
                            </div>
                        </td>
                    </tr>
