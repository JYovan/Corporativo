        ...
        <table  width="100%">
            <tr>
                ...
                <td width="20%" align="right">
                    <button type="button" id="regresar" name="regresar" class="btn btn-primary"  onclick="location.href = '<?php echo base_url(); ?>index.php/controlador/View_Referenciados?i=<?php echo $indice ?>'">Regresar</button>
                </td>
            </tr>
        </table>
    </div>
