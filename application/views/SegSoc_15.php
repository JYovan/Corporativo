...
<?php echo form_open_multipart('controlador/SS_15'); ?> 
                    ...
                    <tr>
                        <td bgcolor="#ff6600" align="center">
                            <strong style="color:#FFF">
                                Generar nómina de trabajadores de clientes
                            </strong>
                        </td>
                    </tr>  
                    <tr>
                    ...
                    <tr>
                        <td>
                            <div class="col-xs-12 col-sm-12">
                                ...
                                <div class="col-md-3 col-xs-6">
                                    <input  class="form-control" type="text" name="Trabajadores" id="Trabajadores">
                                    </br>
                                </div>    
                            </div>
                        </td>
                        ...
                        <td  bgcolor="#99A79A">
                            <div class="col-xs-12 col-sm-12">
                                <label for="DatosL" class="control-label">
                                    Estado del trámite de generar nómina de trabajadores de clientes
                                </label><br>		
                            </div>
                        </td>
                    </tr>
