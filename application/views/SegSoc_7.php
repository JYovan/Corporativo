...
<?php echo form_open_multipart('controlador/SS_7'); ?> 
                ...
                <table width="100%">
                    <tr>
                        <td bgcolor="#ff6600" align="center">
                            <strong style="color:#FFF">Presentar movimientos patronales ante el IMSS de bajas de los trabajadores
                            </strong>
                        </td>
                    </tr>  
                    <tr>
                        ...
                        <td  bgcolor="#99A79A">
                            <div class="col-xs-12 col-sm-12">
                                <label for="DatosL" class="control-label">
                                    Estado del trámite de presentar movimientos patronales 
                                    ante el IMSS  de bajas de los trabajadores
                                </label><br>		
                            </div>
                        </td>
                    </tr>
