...
<?php echo form_open_multipart('controlador/Cedular_G'); ?> 
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td>
                            ...
                            foreach ($DeclaracionesCG as $Declaraciones1) {
                            ...
                            <nav class="navbar navbar-default" role="navigation">
                                ...
                                <div class="collapse navbar-collapse navbar-ex1-collapse" style="font-size:12px">
                                    <ul class="nav navbar-nav">
                                        <li class="active"><a href='<?php echo base_url(); ?>index.php/controladorCalculo/ubicacion?ID=11&Cl=<?php echo $ID_cliente ?>&i=<?php echo $indice ?>'><strong>Cedular Actividades Empresariales de Régimen General</strong></a></li>
                                        <li><a href='<?php echo base_url(); ?>index.php/controladorCalculo/ubicacion?ID=9&Cl=<?php echo $ID_cliente ?>&i=<?php echo $indice ?>'><strong>Cedular por Arrendamientos</strong></a></li>
                    ...
                    <tr>
                        <td  bgcolor="#ff6600">
                            <div class="col-xs-12 col-sm-12">
                                <label for="Redes" class="control-label">Impuesto Cedular por Actividades Empresariales de Régimen General</label><br>		
                            </div>
                        </td>
                    </tr>    
                    <tr>
...
<script>
    cli.config.CedularG_1();
    cli.config.CedularG_2();
    cli.config.CedularG_3();
    cli.config.CedularG_4();
    cli.config.CedularG_5();
    cli.config.CedularG_6();
    cli.config.CedularG_7();
    cli.config.CedularG_8();
    cli.config.CedularG_9();
    cli.config.CedularG_10();
    cli.config.RecargosCedularG();
</script>
