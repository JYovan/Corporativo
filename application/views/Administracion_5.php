...
<?php echo form_open_multipart('controlador/ISR_R12'); ?> 
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td>
                            ...
                            foreach ($DeclaracionesR12 as $Declaraciones1) {
...
<?php } ?>
                    ...
                    <tr>
                        <td  bgcolor="#ff6600">
                            <div class="col-xs-12 col-sm-12">
                                <label for="Redes" class="control-label">ISR RETENCIONES POR SALARIOS R12</label><br>		
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <div class="col-xs-12 col-sm-12">	  
                                ...
                                <div class="col-md-3 col-xs-6" align="right">
                                    Diesel automotríz para el Transporte
                                </div>
                                <div class="col-md-3 col-xs-6" align="left">
