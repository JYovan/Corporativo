...
<div class="container">	
    ...
    <?php echo form_open_multipart('controlador/S_nomina'); ?> 
            ...
            <td>
                <table width="100%">
                    ...
                    <tr>
                        <td>
                            ...
                            foreach ($DeclaracionesSN as $Declaraciones1) {
                                ...
                                if ($mes == 1) {
                                    $Enero = number_format($Declaraciones1->S_nomina, 0, '.', ',') . " (" . $Declaraciones1->Anio . ")";
                                }

                                if ($mes == 2) {
                                    $Febrero = number_format($Declaraciones1->S_nomina, 0, '.', ',') . " (" . $Declaraciones1->Anio . ")";
                                }

                                if ($mes == 3) {
                                    $Marzo = number_format($Declaraciones1->S_nomina, 0, '.', ',') . " (" . $Declaraciones1->Anio . ")";
                                }

                                if ($mes == 4) {
                                    $Abril = number_format($Declaraciones1->S_nomina, 0, '.', ',') . " (" . $Declaraciones1->Anio . ")";
                                }

                                if ($mes == 5) {
                                    $Mayo = number_format($Declaraciones1->S_nomina, 0, '.', ',') . " (" . $Declaraciones1->Anio . ")";
                                }

                                if ($mes == 6) {
                                    $Junio = number_format($Declaraciones1->S_nomina, 0, '.', ',') . " (" . $Declaraciones1->Anio . ")";
                                }

                                if ($mes == 7) {
                                    $Julio = number_format($Declaraciones1->S_nomina, 0, '.', ',') . " (" . $Declaraciones1->Anio . ")";
                                }

                                if ($mes == 8) {
                                    $Agosto = number_format($Declaraciones1->S_nomina, 0, '.', ',') . " (" . $Declaraciones1->Anio . ")";
                                }

                                if ($mes == 9) {
                                    $Septiembre = number_format($Declaraciones1->S_nomina, 0, '.', ',') . " (" . $Declaraciones1->Anio . ")";
                                }

                                if ($mes == 10) {
                                    $Octubre = number_format($Declaraciones1->S_nomina, 0, '.', ',') . " (" . $Declaraciones1->Anio . ")";
                                }

                                if ($mes == 11) {
                                    $Noviembre = number_format($Declaraciones1->S_nomina, 0, '.', ',') . " (" . $Declaraciones1->Anio . ")";
                                }

                                if ($mes == 12) {
                                    $Diciembre = number_format($Declaraciones1->S_nomina, 0, '.', ',') . " (" . $Declaraciones1->Anio . ")";
                                }
                            }
                            ?>
                    ...
                    <tr>
                        <td  bgcolor="#99A79A">
                            <div class="col-xs-12 col-sm-12">
                                <label for="Redes" class="control-label">Impuesto sobre Nómina</label><br>		
                            </div>
                        </td>
                    </tr>    
                    <tr>
                        ...
                        <td>
                            <div class="col-xs-12 col-sm-12">  
                                ...
                                <div class="col-md-3 col-xs-6" align="left" id="L_Importe">
                                    <input class="form-control" name="S_nomina" id="S_nomina"  value="0" readonly="readonly">
                                    <br />
                                </div>
                                <div class="col-md-3 col-xs-6">
...
<script>
    cli.config.S_nomina1();
    cli.config.S_nomina2();
    cli.config.S_nomina3();
    cli.config.RecargosNomina();
</script>
