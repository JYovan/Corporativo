                ...
                <div class="panel-body">
                    <div align="center">
                        <span  data-toggle="modal" data-easein="swoopIn"> 
                            <button class="btn btn-default btn-lg fa-lg" id="btnNuevo"
                                    data-toggle="tooltip" 
                                    data-placement="top" 
                                    title=""  type="button"
                        ...
                        <button id="btnCancelar" class="btn btn-default btn-lg fa-lg" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                                data-original-title="CANCELAR">
                            <span class="fa fa-times fa-3x danger-icon"></span>
                        </button>
                        <button id="btnCompraVenta" class="btn btn-default btn-lg fa-lg" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                                data-original-title="DATOS DE COMPRAVENTA">
                            <span class="fa fa-money fa-3x lime-icon"></span>
                        </button> 
                        <button id="btnFideicomiso" class="btn btn-default btn-lg fa-lg" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                        ...
                        <button id="btnExpediente" class="btn btn-default btn-lg fa-lg" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                                data-original-title="ADJUNTAR EXPEDIENTE DE INMUEBLE">
                            <span class="fa fa-paperclip fa-3x bluegrey-icon"></span>
                        </button> 
                        <button id="btnVerExpedientes" class="btn btn-default btn-lg fa-lg" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                        ...
                        <button id="btnEditarExpediente" class="btn btn-default btn-lg fa-lg hide" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                        ...
                        <button id="btnEliminarExpediente" class="btn btn-default btn-lg fa-lg hide" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-lg fa-lg btn-default" data-toggle="tooltip" data-placement="top" title="" data-original-title="GUARDAR"  type="button" id="btnSave" name="btnSave" ><span class="fa fa-check fa-3x"></span></button>
            </div>
        </div>
    </div>
</div>
...
<div id="mdlModificar" class="modal  animated zoomInUp"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                ...
                <div id="messages-result" class="modal-body text-center">
                    <fieldset> 
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="FechaCompraVenta" name="FechaCompraVenta" placeholder="EJ: 31/12/2017" data-provide="datepicker" data-date-format="dd/mm/yyyy" readonly=""/>
                        </div>
                        <div class="col-md-4">
...
<div id="mdlCompraVenta" class="modal  animated zoomInUp"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="frmCompraVenta">
                <div id="messages-result" class="modal-body text-center">
                    <fieldset> 
                        <div class="col-md-12">
                            <label class="text-danger">* SOLO APARECEN LOS MOVIMIENTOS CON UBICACION *</label>
...
<div id="mdlFideicomiso" class="modal  animated zoomInUp"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
...
<div id="mdlExpediente" class="modal  animated zoomInUp"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
...
<div id="mdlModificarExpediente" class="modal  animated zoomInUp"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
...
<script>
    ...
    var btnSavemdlFideicomiso = mdlFideicomiso.find("#btnSave");
    ...
    $(document).ready(function () {
        ...
        btnSavemdlFideicomiso.click(function () {
            HoldOn.open({
                theme: "sk-bounce",
                message: "GUARDANDO POR FAVOR ESPERE..."
            });
            var frm = new FormData(mdlFideicomiso.find('form')[0]);
            $.ajax({
                url: master_url + 'onFideicomiso',
                type: "POST",
                cache: false,
                contentType: false,
                processData: false,
                ...
                mdlFideicomiso.modal('hide');
                btnRefresh.trigger('click');
                    onNotify('<span class="fa fa-check fa-lg"></span>', ' REGISTRO ACTUALIZADO', 'danger');
            }).fail(function (x, y, z) {
                console.log(x, y, z);
            }).always(function () {
                HoldOn.close();
        ...
        btnCancelar.click(function () {
            if (temp !== undefined && temp !== null && temp > 0) {
                ...
                $.ajax({
                    ...
                    console.log(data, x, jq);
                    btnRefresh.trigger('click');
                    onNotify('<span class="fa fa-exclamation fa-lg"></span>', ' REGISTRO CANCELADO', 'danger');
                }).fail(function (x, y, z) {
                    console.log(x, y, z);
                }).always(function () {
                    HoldOn.close();
        ...
        btnEditar.click(function () {
            ...
            mdlModificar.find('#tblAdjuntos').html("");
            if (temp !== undefined && temp !== null && temp > 0) {
                HoldOn.open({
                    theme: "sk-bounce",
                    message: "POR FAVOR ESPERE..."
...
//            $(".modal").find("#IdProveedor").html(options);
    ...
    function getBienesInmuebles()
    {
        ...
        $.ajax({
            ...
            var options = "<option></option>";
            $.each(data, function (k, v) {
                options = options + '<option value="' + v.ID + '" >(' + v.PROPIETARIO + ') ' + '(' + ((v.RFC.length > 0) ? v.RFC : 'SIN RFC') + ') ' + v.UBICACION + '</option>';
            });
