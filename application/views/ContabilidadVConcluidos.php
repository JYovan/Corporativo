        ...
        <tr>
            <td>
                <table width="100%">    
                    <tr>
                        <td bgcolor="#ff6600">
                            <strong style="color:#FFF">Visualización de trámites contables concluidos</strong>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <div class="col-xs-12 col-sm-12" id="ResultadoConcluidos">
