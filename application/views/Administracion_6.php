...
<?php echo form_open_multipart('controlador/ISR_R5'); ?> 
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td>
                            ...
                            foreach ($DeclaracionesR5 as $Declaraciones1) {
                                $mes = $Declaraciones1->meses;
                                if ($mes == 1) {
                                    $Enero = $Declaraciones1->CantCargo_R . " (" . $Declaraciones1->Anio . ")";
                                }

                                if ($mes == 2) {
                                    $Febrero = $Declaraciones1->CantCargo_R . " (" . $Declaraciones1->Anio . ")";
                                }

                                if ($mes == 3) {
                                    $Marzo = $Declaraciones1->CantCargo_R . " (" . $Declaraciones1->Anio . ")";
                                }

                                if ($mes == 4) {
                                    $Abril = $Declaraciones1->CantCargo_R . " (" . $Declaraciones1->Anio . ")";
                                }

                                if ($mes == 5) {
                                    $Mayo = $Declaraciones1->CantCargo_R . " (" . $Declaraciones1->Anio . ")";
                                }

                                if ($mes == 6) {
                                    $Junio = $Declaraciones1->CantCargo_R . " (" . $Declaraciones1->Anio . ")";
                                }

                                if ($mes == 7) {
                                    $Julio = $Declaraciones1->CantCargo_R . " (" . $Declaraciones1->Anio . ")";
                                }

                                if ($mes == 8) {
                                    $Agosto = $Declaraciones1->CantCargo_R . " (" . $Declaraciones1->Anio . ")";
                                }

                                if ($mes == 9) {
                                    $Septiembre = $Declaraciones1->CantCargo_R . " (" . $Declaraciones1->Anio . ")";
                                }

                                if ($mes == 10) {
                                    $Octubre = $Declaraciones1->CantCargo_R . " (" . $Declaraciones1->Anio . ")";
                                }

                                if ($mes == 11) {
                                    $Noviembre = $Declaraciones1->CantCargo_R . " (" . $Declaraciones1->Anio . ")";
                                }

                                if ($mes == 12) {
                                    $Diciembre = $Declaraciones1->CantCargo_R . " (" . $Declaraciones1->Anio . ")";
                                }
                            }
                            ?>
...
if ($length != 12) {
    ?>
                                            ...
                                            <li class="active"><a href='<?php echo base_url(); ?>index.php/controladorCalculo/ubicacion?ID=5&Cl=<?php echo $Folio ?>&i=<?php echo $indice ?>'><strong>ISR Salarios</strong></a></li>
...
<?php } ?>
                    ...
                    <tr>
                        <td  bgcolor="#ff6600">
                            <div class="col-xs-12 col-sm-12">
                                <label for="Redes" class="control-label">ISR RETENCIONES POR SALARIOS R5</label><br>		
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <div class="col-xs-12 col-sm-12">	  
                                ...
                                <div class="col-md-3 col-xs-6" align="right">
                                    Crédito IEPS Disel sector Primario y Minero		  	
                                </div>
                                <div class="col-md-3 col-xs-6" align="left">
                    ...
                    <tr>
                        <td>
                            <div class="col-xs-12 col-sm-12">	  
                                ...
                                <div class="col-md-3 col-xs-6" align="right">
                                    Disel automotríz para el Transporte
                                </div>
                                <div class="col-md-3 col-xs-6" align="left">
