                ...
                <div class="panel-body">
                        ...
                        <div id="btnAccions" align="center" class="col-md-12">
                            <fieldset>
                                <span  data-toggle="modal" data-easein="swoopIn" data-target="#mdlNuevo" >
                                    <button id="btnAgregarTramiteFactura" class="btn btn3d btn-lg btn-default fa-3x box-shadow"  data-toggle="tooltip" data-placement="top" title="" data-original-title="NUEVO">
                                        <span class="fa fa-plus fa-lg info-icon"></span>
                                    </button>
                                </span>
                                <button id="btnModificar" class="btn btn3d btn-lg btn-default fa-3x"
                                ...
                                <button id="btnCancelarPago" class="btn btn3d btn-lg btn-default fa-3x disabled"
                                        data-toggle="tooltip" data-placement="top" title="" data-original-title="CANCELAR PAGO"  >
                                    <span class="fa fa-times fa-lg danger-icon"></span></button>
                                <!--                            <button id="btnFacturasCanceladas" class="btn btn3d btn-lg btn-default fa-3x hide"
                                ...
                                <button id="btnCancelarPrestamo" class="btn btn3d btn-lg btn-default fa-3x"
                                        data-toggle="tooltip" data-placement="top" title="" data-original-title="CANCELAR PRESTAMO">
                                    <span class="fa fa-ban fa-lg"></span>
                                </button>  <button id="btnConsultarSaldos" class="btn btn3d btn-lg btn-default fa-3x"
                                                   data-toggle="tooltip" data-placement="top" title="" data-original-title="CONSULTA DE SALDOS">
                                    <span class="fa fa-file-text fa-lg purple-icon"></span>
                                </button>  
                                <button id="btnPagar" class="btn btn3d btn-lg btn-default fa-3x"  data-toggle="tooltip" data-placement="top" title="" data-original-title="GENERAR PAGO">
                                    <span class="fa fa-money fa-lg bluegrey-icon"></span>
                                </button> 
                                <span  data-toggle="hide" data-easein="swoopIn" data-target="#content-busqueda" >
                                    <button id="btnBuscar" class="btn btn3d btn-lg btn-default fa-3x" data-toggle="tooltip" data-placement="top" title="" data-original-title="BUSQUEDA ESPECIFICA"  >
                                        <span class="fa fa-search fa-lg brown-icon"></span>
                                    </button> 
                                </span>
                                <button id="btnConsultarPagos" class="btn btn3d btn-lg btn-default fa-3x"  data-toggle="tooltip" data-placement="top" title="" data-original-title="HISTORIAL DE PAGOS">
                                    <span class="fa fa-eye fa-lg cyan-icon"></span>
                                </button>  
                                <button id="btnAyuda" class="btn btn3d btn-lg btn-default fa-3x"  data-toggle="tooltip" data-placement="top" title="" data-original-title="AYUDA">
                                    <span class="fa fa-magic fa-lg yellow-icon"></span>
                                </button>  
                    ...
                    <fieldset id="dSearch" accesskey="s" class="hide">
                        <form id="fSearch">
                            ...
                            <div class="col-xs-12 col-md-1">
                                <button id="btnBuscarAhora"  type="button" class="btn btn3d btn-lg btn-default fa-lg"  data-toggle="tooltip" data-placement="top" title="" data-original-title="BUSCAR">
                                    <span class="fa fa-search fa-3x kingblue-icon"></span>
                                </button> 
                            </div>
                            <div class="col-xs-12 col-md-1">
                                <button id="btnResetBuscar"  type="button" class="btn btn3d btn-lg btn-default fa-lg"  data-toggle="tooltip" data-placement="top" title="" data-original-title="RESETEAR">
                                    <span class="fa fa-trash fa-3x kingblue-icon"></span>
                                </button>  
                            </div>
                        </form>
                        <div class="col-xs-12 col-md-2">
                            <button id="btnAcumulado" type="button" class="btn btn3d btn-lg btn-default fa-3x"  data-toggle="tooltip" data-placement="top" title="" data-original-title="ACUMULADO">
                                <span class="fa fa-list-ol fa-lg kingblue-icon"></span> 
                        </div>
                        <div class="col-xs-12 col-md-2">
                            <button id="btnAcumuladoAgrupado" type="button" class="btn btn3d btn-lg btn-default fa-3x"  data-toggle="tooltip" data-placement="top" title="" data-original-title="ACUMULADO AGRUPADO">
                                <span class="fa fa-list-alt fa-lg kingblue-icon"></span> 
                        </div>
                    </fieldset>
                    <fieldset id="dSearchHistory" accesskey="s" class="hide">
                        <form id="fSearchHistory">
                            ...
                            <div class="col-xs-12 col-md-1">
                                <button id="btnBuscarHistorial"  type="button" class="btn btn3d btn-lg btn-default fa-lg"  data-toggle="tooltip" data-placement="top" title="" data-original-title="BUSCAR">
                                    <span class="fa fa-search fa-lg"></span>
                                </button> 
                            </div>
                            <div class="col-xs-12 col-md-1">
                                <button id="btnResetBuscarHistorial"  type="reset" class="btn btn3d btn-lg btn-default fa-lg"  data-toggle="tooltip" data-placement="top" title="" data-original-title="RESETEAR">
...
<div id="mdlAyuda" class="modal animated zoomInUp"  data-easein="swoopIn"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<div id="mdlNuevo" class="modal  animated zoomInUp"  data-easein="swoopIn"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg fullscreen" role="document">
        <div class="modal-content">
            ...
            <form id="fNuevo">
                <div class="modal-body">
                    <fieldset>
                        ...
                        <div class="col-xs-12 col-md-4">
                            <input type="file" class="btn btn-default hide" id="rtImagen" name="rtImagen">
                        </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default zoomIn" data-dismiss="modal"><span class="fa fa-times fa-3x"></span></button>
                <button id="btnAdd" type="button" class="btn btn-default" ><span class="fa fa-check fa-3x"></span></button>
                <button id="btnAddProgress" type="button" class="btn btn-default hide"><span class="fa fa-refresh fa-spin fa-3x"></span></button>
            </div>
        </div>
    </div>
</div>
...
<div id="mdlModificar" class="modal animated zoomInUp"  data-easein="swoopIn"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg fullscreen" role="document">
        <div class="modal-content">
            ...
            <form id="fModificar">
                <div class="modal-body">
                    <fieldset>
                        ...
                        <div class="col-xs-12 col-md-4">
                            <input type="file" class="btn btn-default hide" id="rtImagenU" name="rtImagenU">
                        </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default zoomIn" data-dismiss="modal"><span class="fa fa-times fa-3x"></span></button>
                <button id="btnUpdate" type="button" class="btn btn-default" ><span class="fa fa-check fa-3x"></span></button>
                <button id="btnUpdateProgress" type="button" class="btn btn-default hide"><span class="fa fa-refresh fa-spin fa-3x"></span></button>
            </div>
        </div>
    </div>
</div>

<div id="mdlPago" class="modal animated zoomInUp"  data-easein="swoopIn"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg fullscreen" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default zoomIn" data-dismiss="modal"><span class="fa fa-times fa-3x"></span></button>
                <button id="btnAddPago" type="button" class="btn btn-default" ><span class="fa fa-check fa-3x"></span></button>
                <button id="btnAddPagoProgress" type="button" class="btn btn-default disabled hide"><span class="fa fa-refresh fa-spin fa-3x"></span></button>
            </div>
        </div>
    </div>
</div>
