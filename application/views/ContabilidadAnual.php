...
<?php echo form_open_multipart(base_url().'index.php/controlador/CAnual'); ?> 
        ...
        <tr>
            <td>
                <table width="100%">    
                    <tr>
                        <td bgcolor="#ff6600">
                            <strong style="color:#FFF">Declaración Anual</strong>
                        </td>
                    </tr>
                    <tr>
                        <td>
...
<?php } ?>
                        ...
                        <td  bgcolor="#99A79A">
                            <div class="col-xs-12 col-sm-12">
                                <label for="DatosL" class="control-label">
                                    Estado de la declaración anual </label><br>		
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="col-xs-12 col-sm-12">
                                <div class="col-xs-6 col-sm-6">
                                    <label for="Documento" class="control-label">Declaración en proceso</label>
                                </div>
                                <div class="col-xs-3 col-sm-3">
                    ...
                    <tr>
                        <td>
                            <div class="col-xs-12 col-sm-12">
                                <div class="col-xs-6 col-sm-6">
                                    <label for="Documento" class="control-label">Declaración concluído </label>
                                </div>
                                <div class="col-xs-3 col-sm-3">
                    ...
                    <tr>
                        <td>
                            <div class="col-xs-12 col-sm-12">
                                <div class="col-xs-6 col-sm-6">
                                    <label for="Documento" class="control-label">Declaración  entregado al área fiscal</label>
                                </div>
                                <div class="col-xs-3 col-sm-3">
                    ...
                    <tr>
                        <td>
                            <div class="col-xs-12 col-sm-12">
                                <div class="col-xs-6 col-sm-6">
                                    <label for="Documento" class="control-label">Declaración  notificado al cliente</label>
                                </div>
                                <div class="col-xs-3 col-sm-3">
                    ...
                    <tr>
                        <td>
                            <div class="col-xs-12 col-sm-12">
                                <div class="col-xs-6 col-sm-6">
                                    <label for="Documento" class="control-label">Declaración  integrado al expediente mensual del cliente</label>
                                </div>
                                <div class="col-xs-3 col-sm-3">
