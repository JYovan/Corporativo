...
<?php echo form_open_multipart('controlador/SS_10'); ?> 
                    ...
                    <tr>
                        <td bgcolor="#ff6600" align="center">
                            <strong style="color:#FFF">
                                Presentar aviso de modificación de datos de contador público autorizado ante el IMSS
                            </strong>
                        </td>
                    </tr>  
                    <tr>
                        ...
                        <td  bgcolor="#99A79A">
                            <div class="col-xs-12 col-sm-12">
                                <label for="DatosL" class="control-label">
                                    Estado del trámite de presentar aviso de modificación 
                                    de datos de contador público autorizado ante el IMSS 
                                </label><br>		
                            </div>
                        </td>
                    </tr>
