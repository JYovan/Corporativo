        ...
        <tr>
            <td>
                <table width="100%">    
                    <tr>
                        <td bgcolor="#ff6600">
                            <strong style="color:#FFF">Estado de ingresos a caja de administración</strong>
                        </td>
                    </tr>
                    <tr>
                        <td>
...
<?php } ?>
                    ...
                    <tr>
                        <td bgcolor="#99A79A" align="center">
                            <div class="col-xs-12 col-sm-12" align="left">
                                <strong style="color:#FFF">Estado de cuenta del cliente:</strong>	
                            </div>
                        </td>
                    </tr>
                    <tr>
