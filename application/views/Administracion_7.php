...
<?php echo form_open_multipart('controlador/ISR_R7'); ?> 
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td>
                            ...
                            $sumaingresos = 0; //*******************************
                            $impuestoperiodo = 0;
                            foreach ($DeclaracionesR7 as $Declaraciones1) {
...
if ($length != 12) {
    ?>
                                            ...
                                            <li class="active"><a href='<?php echo base_url(); ?>index.php/controladorCalculo/ubicacion?ID=6&Cl=<?php echo $Folio ?>&i=<?php echo $indice ?>'><strong>ISR Act. Empresarial</strong></a></li>      
...
<?php } ?>
                    ...
                    <tr>
                        <td  bgcolor="#ff6600">
                            <div class="col-xs-12 col-sm-12">
                                <label for="Redes" class="control-label">ISR P. FÍSICAS CON ACTIVIDAD EMPRESARIAL O PROFESIONAL R7</label><br>		
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="col-xs-12 col-sm-12">	  
                                ...
                                <div class="col-md-3 col-xs-6" align="left" id="L_Act">
                                    <input class="form-control" name="ParteAct" id="ParteAct"  value="0" required="required">
                                    <br>
                                </div>  		  
                            </div>
