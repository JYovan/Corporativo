...
<?php echo form_open_multipart('controlador/Cedular_H'); ?> 
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td>
                            ...
                            foreach ($DeclaracionesCH as $Declaraciones1) {
                            ...
                            <nav class="navbar navbar-default" role="navigation">
                                ...
                                <div class="collapse navbar-collapse navbar-ex1-collapse" style="font-size:12px">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li class="active"><a href='<?php echo base_url(); ?>index.php/controladorCalculo/ubicacion?ID=10&Cl=<?php echo $ID_cliente ?>&i=<?php echo $indice ?>'><strong>Cedular por Servicios Profesionales</strong></a></li>
                                    </ul>
                                </div>
                            </nav>
                        </td>
                    ...
                    <tr>
                        <td  bgcolor="#ff6600">
                            <div class="col-xs-12 col-sm-12">
                                <label for="Redes" class="control-label">Impuesto Cedular por Servicios Profesionales</label><br>		
                            </div>
                        </td>
                    </tr>
                    <tr>
...
<script>
    cli.config.CedularH_1();
    cli.config.CedularH_2();
    cli.config.CedularH_5();
    cli.config.CedularH_6();
    cli.config.CedularH_7();
    cli.config.CedularH_8();
    cli.config.CedularH_9();
    cli.config.CedularH_10();
    cli.config.CedularH_11();
    cli.config.RecargosCedularH();
</script>
