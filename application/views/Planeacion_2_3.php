...
<div class="container">	
    ...
    <?php echo form_open_multipart('controlador3/Planeacion2_3'); ?>  
                    ...
                    <tr>
                        <td> 
                            <div class="col-md-4 col-xs-12">	
                                <div class="col-md-12 col-xs-12">
                                    <label for="1" class="control-label">Concepto de material</label><br>
                                </div>  
                                <div class="col-md-12 col-xs-12">
                            ...
                            <div class="col-md-4 col-xs-12">	
                                <div class="col-md-12 col-xs-12">
                                    <label for="2" class="control-label">Cantidad de material por prenda</label><br>
                                </div>  
                                <div class="col-md-12 col-xs-12">
                                    <input style="text-transform:uppercase" onkeyup="javascript:this.value = this.value.toUpperCase()"   type="text" class="form-control" name="Cantidad" id="Cantidad" >
                                </div>
                            </div>

                            <div class="col-md-4 col-xs-12">	
                                <div class="col-md-12 col-xs-12">
                                    <label for="2" class="control-label">Unidad de medida</label><br>
                                </div>  
                                <div class="col-md-12 col-xs-12" id="Unidad">
