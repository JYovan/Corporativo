...
<?php echo form_open_multipart('controlador/BorrarCobroPen'); ?> 
            ...
            <td>
                <table width="100%">    
                    ...
                    <tr>
                        <td bgcolor="#99A79A">
                            <div class="col-xs-12 col-sm-12">
                                <strong style="color:#FFF">Cobros pendientes</strong>
                            </div>
                        </td>
                    </tr>
                    <tr>
...
<table width="100%">    
    ...
    <tr>
        <td width="20%" align="right">
            <button type="button" id="regresar" name="regresar" class="btn  btn-primary"  onclick="location.href = '<?php echo base_url(); ?>index.php/controlador/Menu?ID=9&i=<?php echo $indice ?>'">Regresar</button>
        </td>
    </tr>
</table> 
</div>
