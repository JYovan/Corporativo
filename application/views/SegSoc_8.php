...
<?php echo form_open_multipart('controlador/SS_8'); ?> 
                    ...
                    <tr>
                        <td bgcolor="#ff6600" align="center">
                            <strong style="color:#FFF">
                                Tramitar alta patronal e inscripción en el seguro de riesgos de trabajo o reanudación de actividades
                            </strong>
                        </td>
                    </tr>  
                    <tr>
                        ...
                        <td  bgcolor="#99A79A">
                            <div class="col-xs-12 col-sm-12">
                                <label for="DatosL" class="control-label">
                                    Estado del trámite de alta patronal e inscripción en el seguro 
