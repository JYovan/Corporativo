    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                    ...
                    <fieldset>
                        ...
                        <script>
                            $(document).ready(function () {
                                ...
                                var vp = mdlNuevo.find("#VistaPrevia");
                                var Icono = mdlNuevo.find("#Icono");
                                var btnIcono = mdlNuevo.find("#btnIcono");
                                ...
                                Icono.change(function () {
                                    ...
                                    fr.onload = function (e) {
                                        vp.html('<br><img src="' + fr.result + '" class="img-responsive">');
                                    };
                                    fr.readAsDataURL(Icono[0].files[0]);
                                });
                            });</script>
            ...
            <div class="modal-footer">
                ...
                <!--<button class="btn btn-lg fa-lg btn-success hide disabled" data-toggle="tooltip" data-placement="top" title="" data-original-title="GUARDAR"  type="button" id="btnGuardando" name="btnGuardando" value="" ><span class="fa fa-cog fa-spin fa-3x fa-fw"></span></button>-->
            </div>
        </div>
    </div>
</div>
