...
<?php echo form_open_multipart('controlador/SS_3'); ?> 
                ...
                <table width="100%">
                    <tr>
                        <td bgcolor="#ff6600" align="center">
                            <strong style="color:#FFF">Generar constancia de movimientos afiliatorios al IMSS </strong>
                        </td>
                    </tr>  
                    <tr>
                        <td>
                        ...
                        <td  bgcolor="#99A79A">
                            <div class="col-xs-12 col-sm-12">
                                <label for="DatosL" class="control-label">
                                    Estado del trámite  de  generar constancia de movimientos afiliatorios al IMSS
                                </label><br>		
                            </div>
                        </td>
                    </tr>
