...
<?php echo form_open_multipart('controlador/BInmueble4'); ?> 
        ...
        <tr>
            <td>
                <table width="100%">    
                    <tr>
                        <td bgcolor="#ff6600">
                            <strong style="color:#FFF">Expediente de inmuebles</strong>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <div class="col-xs-12 col-sm-12">
                                <div class="col-md-3 col-xs-12" align="right">
                                    <label for="Cliente" class="control-label">Seleccionar inmueble:</label><br>
                                </div>
