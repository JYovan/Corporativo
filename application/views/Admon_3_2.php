...
<?php echo form_open_multipart('controlador/SalidaMaterial'); ?> 
                    ...
                    <tr>
                        <td bgcolor="#ff6600" align="center">
                            <div class="col-xs-12 col-sm-12">
                                <strong style="color:#FFF">Control de salidas de artículos y materiales</strong>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#99A79A">
                            <div class="col-xs-12 col-sm-12">
                                <strong style="color:#FFF">Materiales disponibles</strong>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <div class="col-md-4 col-xs-12">
                                ...
                                <div class="col-md-12 col-xs-12">
                                    <select class="form-control" id="Material" name="Material" required="required">
                                        <option value="">Selecciona</option>
                                        <?php foreach ($Material as $Material1) { ?> 
                                            <option value="<?php echo $Material1->ID; ?>"><?php echo $Material1->Material; ?></option>
<?php } ?>
                                    </select>
                                    </br>
                                </div>
                    ...
                    <tr>
                        <td>
                            <div class="col-xs-12 col-sm-12" id="InfoMaterial">
                    ...
                    <tr>
                        <td  bgcolor="#99A79A">
                            <div class="col-xs-12 col-sm-12">
                                <label for="DatosL" class="control-label">Registro de salida</label><br>		
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="col-md-4 col-xs-12">
                                <div class="col-md-12 col-xs-12">
                                    Nombre de quien asigna:
                                </div>
                                <div class="col-md-12 col-xs-12">
                                    <select class="form-control" id="Asigna" name="Asigna"  required>
                                        <option value="">Selecciona</option>
...
<?php } ?>
                            ...
                            <div class="col-md-4 col-xs-12">
                                ...
                                <div class="col-md-12 col-xs-12">
                                    <select class="form-control" id="Recibe" name="Recibe"  required>
                                        <option value="">Selecciona</option>
                                        <?php foreach ($USUARIOS as $temporal) { ?> 
                                            <option value="<?php echo $temporal->Id; ?>"><?php echo $temporal->nombre . " " . $temporal->apaterno . " " . $temporal->amaterno; ?></option>
<?php } ?>
