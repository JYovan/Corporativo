...
<?php echo form_open_multipart(base_url().'index.php/controlador/OrdenCompra2'); ?>    
                    ...
                    <tr>
                        <td bgcolor="#99A79A">
                            <div class="col-xs-12 col-sm-12">
                                <strong style="color:#FFF">Selección de la cotización</strong>		
                            </div>
                        </td>
                    </tr>
                        ...
                        <td>
                            <div class="col-md-12 col-xs-12">	
                                ...
                                <div class="col-md-8 col-xs-12">
                                    <select class="form-control" id="Cotizacion" name="Cotizacion"   required="required">
                                        <option value="">Selecciona</option>
                                            <?php foreach ($CotizacionALL as $Autorizadas1) { ?> 
                                            <option value="<?php echo $Autorizadas1->ID; ?>">
                                                <?php
                                                foreach ($Proyectos as $Proyectos1) {
                                                    if ($Proyectos1->ID == $Autorizadas1->Proyecto) {
                                                        $Proy = $Proyectos1->Proyecto;
                                                        ?>
            <?php echo " COT-" . $Autorizadas1->Numero . " " . $Proy; ?></option>
        <?php }
    }
} ?>
                                    </select>
...
<script>
    cli.config.Aprobaciones2();
    cli.config.OrdenCompraPDF();
</script>