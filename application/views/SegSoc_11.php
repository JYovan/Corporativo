...
<?php echo form_open_multipart('controlador/SS_11'); ?> 
                        ...
                        <td  bgcolor="#99A79A">
                            <div class="col-xs-12 col-sm-12">
                                <label for="DatosL" class="control-label">
                                    Estado del trámite de presentar aviso de movimientos afiliatorios de trabajadores
                                </label><br>		
                            </div>
                        </td>
                    </tr>
