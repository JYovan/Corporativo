...
<?php echo form_open_multipart('controlador/ISR_R15'); ?> 
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td>
                            ...
                            foreach ($DeclaracionesR15 as $Declaraciones1) {
...
<?php } ?>
                    ...
                    <tr>
                        <td  bgcolor="#ff6600">
                            <div class="col-xs-12 col-sm-12">
                                <label for="Redes" class="control-label">ISR RETENCIONES POR ARRENDAMIENTO DE INMUEBLES R15</label><br>		
                            </div>
                        </td>
                    </tr>
