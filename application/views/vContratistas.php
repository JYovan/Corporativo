                    ...
                    <div id="btnAccions" align="center">
                        <fieldset>
                            <span  data-toggle="modal" data-easein="swoopIn" data-target="#mdlConceptoDePago" > 
                                <button id="btnAdd" type="button" class="btn btn3d btn-lg btn-default fa-lg"  data-toggle="tooltip" data-placement="top" title="" data-original-title="NUEVO">
                                    <span class="fa fa-plus fa-lg info-icon fa-3x"></span>
                                </button>
                            </span>
                            <button id="btnEdit" class="btn btn3d btn-lg btn-default fa-lg"  type="button" 
                                    data-toggle="tooltip" data-placement="top" title="" data-original-title="MODIFICAR"  ><span class="fa fa-pencil fa-3x success-icon"></span></button>
                            <button id="btnRefresh" class="btn btn3d btn-lg btn-default fa-lg"  type="button" 
                            ...
                            <button id="btnCancel" class="btn btn3d btn-lg btn-default fa-lg"  type="button" 
                                    data-toggle="tooltip" data-placement="top" title="" data-original-title="CANCELAR"  ><span class="fa fa-times fa-3x danger-icon"></span></button>
                            <button id="btnReport" class="btn btn3d btn-lg btn-default fa-lg"  type="button" 
                            ...
                            <button id="btnReportCDD" class="btn btn3d btn-lg btn-default fa-lg"  type="button" 
                                    data-toggle="tooltip" data-placement="top" title="" data-original-title="CONCEPTO DE DESTAJO"  >
                                <span class="fa fa-file-text-o fa-3x lime-icon"></span>
                            </button>

                            <button id="btnPayment" class="btn btn3d btn-lg btn-default fa-lg"  type="button" 
                                    data-toggle="tooltip" data-placement="top" title="" data-original-title="PAGOS" type="button">
                                <span class="fa fa-money fa-3x bluegrey-icon"></span>
                            </button> 
                            <button id="btnPaymentMultiple" class="btn btn3d btn-lg btn-default fa-lg"  type="button" 
                                    data-toggle="tooltip" data-placement="top" title="" data-original-title="PAGO MUTIPLE" type="button">
                                <span class="fa fa-money fa-3x cyan-icon"></span>
                            </button> 
                            <button id="btnHistoryPayments" class="btn btn3d btn-lg btn-default fa-lg"  type="button" 
                            ...
                            <button id="btnChart" class="btn btn3d btn-lg btn-default fa-lg"  type="button" 
                                    data-toggle="tooltip" data-placement="top" title="" data-original-title="REPORTE GRÁFICO" type="button">
                                <span class="fa fa-bar-chart fa-3x black-icon"></span>
                            </button>
