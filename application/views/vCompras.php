        ...
        <div class="panel panel-primary container-fluid">
            ...
            <div class="panel-body">
                <fieldset>
                    <div class="col-md-12" align="center"> 
                            <span  data-toggle="modal" data-easein="swoopIn" data-target="#mdlNuevoOC" >
                                <button id="btnAdd" class="btn btn-lg fa-lg btn-default" data-toggle="tooltip" data-placement="top" title="" data-original-title="NUEVO">
                                    <span class="fa fa-plus fa-3x info-icon"></span>
                                </button>
                            </span> 
                            <button id="btnEdit" class="btn btn-lg fa-lg btn-default" data-toggle="tooltip" data-placement="top" title="" data-original-title="EDITAR">
                                <span class="fa fa-pencil fa-3x success-icon"></span>
                            </button> 
                        <button id="btnRefresh" class="btn btn-lg fa-lg btn-default" data-toggle="tooltip" data-placement="top" title="" data-original-title="REFRESCAR">
                            <span class="fa fa-refresh fa-3x warning-icon"></span>
                        </button>
                        <button id="btnApproved" class="btn btn-lg fa-lg btn-default" data-toggle="tooltip" data-placement="top" title="" data-original-title="APROBAR COTIZACIÓN / PRESUPUESTO">
                            <span class="fa fa-check fa-3x danger-icon"></span>
                        </button>
                        <!--                        <button id="btnReview" class="btn btn-lg fa-lg btn-brown" data-toggle="tooltip" data-placement="top" title="" data-original-title="VER ">
                                                    <span class="fa fa-eye fa-3x"></span>
                                                </button>-->
                        <button id="btnCanceledRecords" class="btn btn-lg fa-lg btn-default" data-toggle="tooltip" data-placement="top" title="" data-original-title="VER REGISTROS CANCELADOS">
                            <span class="fa fa-eye-slash fa-3x lime-icon"></span>
                        </button>
                        <button id="btnForwardC" class="btn btn-lg fa-lg btn-default hide" data-toggle="tooltip" data-placement="top" title="" data-original-title="AVANZAR">
                            <span class="fa fa-play fa-3x cyan-icon"></span>
                        </button>
                        <button id="btnCancel" class="btn btn-lg fa-lg btn-default" data-toggle="tooltip" data-placement="top" title="" data-original-title="CANCELAR">
                            <span class="fa fa-times fa-3x cyan-icon"></span>
                        </button>
                        <button id="btnForwardOC" class="btn btn-lg fa-lg btn-default hide" data-toggle="tooltip" data-placement="top" title="" data-original-title="AVANZAR Y APROBAR">
                            <span class="fa fa-forward fa-3x purple-icon"></span>
                        </button>
                        <button id="btnReport" class="btn btn-lg fa-lg btn-default" data-toggle="tooltip" data-placement="top" title="" data-original-title="GENERAR COTIZACIÓN">
                            <span class="fa fa-file fa-3x purple-icon"></span>
                        </button>
                        <button id="btnReporting" class="btn btn-lg fa-lg btn-default hide" data-toggle="tooltip" data-placement="top" title="" data-original-title="GENERANDO...">
                ...
                <div class="col-xs-12 col-sm-12 hide">
                    <button class="btn btn-lg fa-lg btn-default btn-block" type="submit"  id="user" name="user" value="<?php echo $indice; ?>">Continuar</button>		
                </div> 
                </form>
            </div>
        </div>
...
<!--                                                <td>
                                                ...
                                                <td>
                                                    <div id="dbtnAdd" class="col-md-1">
                                                        <button class="btn btn-default btn-sm btnAddRow" type="button" id="Agregar" name="Agregar" data-toggle="tooltip" data-placement="top" title="" data-original-title="Agregar"  ><span class="fa fa-plus fa-4x"></span></button>
                                                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default " data-dismiss="modal" data-toggle="tooltip" data-placement="top" title="" data-original-title="CANCELAR"><span class="fa fa-close fa-3x"></span></button>  
                <!--<button type="button" class="btn btn-default"><span class="fa fa-check fa-3x" data-toggle="tooltip" data-placement="top" title="" data-original-title="APROBAR"></span></button>--> 
                <div id="dbtnSave" class="hide">
                    <!--<i class="fa fa-spinner fa-pulse fa-3x fa-fw"></i>-->
                </div>
                <!--<button id="btnSaveCog" type="button" class="btn btn-default hide disabled" data-toggle="tooltip" data-placement="top" title="" data-original-title="GUARDANDO"><span class="fa fa-cog fa-spin fa-3x fa-fw"></span></button>--> 
                <button id="btnSave" type="button" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="" data-original-title="GUARDAR"><span class="fa fa-save fa-3x"></span></button> 
            </div>
        </div>
    </div>
</div>
...
<div id="mdlUpdateOC" class="modal fade"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                    ...
                    <fieldset>
                        ...
                        <div id="pnlAddProductos" class="col-md-12 hide">
                            <fieldset>
                                ...
                                <div class="col-md-1">
                                    <button type="button" class="btn btn3d btn-default btn-lg fa-lg disabled" id="dbtnAddU">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default " data-dismiss="modal" data-toggle="tooltip" data-placement="top" title="" data-original-title="CERRAR">
                    <span class="fa fa-close fa-3x"></span>
                </button>   
                <button id="btnUpdateRefresh" type="button" class="btn btn-default disabled hide" data-toggle="tooltip" data-placement="top" title="" data-original-title="GUARDANDO...">
                    <span class="fa fa-refresh fa-spin fa-3x"></span>
                </button>
                <button id="btnUpdate" type="button" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="" data-original-title="GUARDAR">
...
<div id="mdlDetalleOC" class="modal fade"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg fullscreen" role="document">
        <div class="modal-content">
                ...
                <div id="pnlResumen" class="modal-body text-center">
                    <fieldset>
                        ...
                        <div class="col-md-6">
                            ...
                            <!--<input type="text" class="form-control" value="ROGELIO RAMIREZ TORRES, ROGELIO ALEJANDRO RAMIREZ TORRES, JORGE SANTA CRUZ CASAS" >--> 
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default " data-dismiss="modal" data-toggle="tooltip" data-placement="top" title="" data-original-title="CANCELAR">
                    <span class="fa fa-close fa-3x"></span>
                </button>
                <button type="button" id="btnApprovedMDL" class="btn btn-default hide disabled">
...
//                $("#Numero").next().remove();
        ...
        $(".btnAddRow").click(function (e) {
            ...
            if ($("#Producto").val() !== undefined && $("#Producto").val() !== '' &&
                ...
                $.ajax({
                    ...
                    if (dtm !== undefined) {
                        $(".tblCProductos tbody").append(
                                ...
                                '<td><button type="button" class="btn btn3d btn-default btn-lg fa-lg btnDeleteRow" onclick="onDeleteRow(this,\'thTOTAL\',\'dMessages\')" data-toggle="tooltip" data-placement="top" title="" data-original-title="ELIMINAR" ><span class="fa fa-minus"></span></button> </td><td class="tdEstatus"><span class="label label-emerald">NUEVO</span></td></tr>');
...
//        console.log(temp);
        ...
        $("#dbtnAddU").click(function (e) {
            e.preventDefault();
            if ($("#UProducto").val() !== undefined && $("#UProducto").val() !== '' &&
...
//                });
                    $.each(rows, function (k, dtm) {
                        $(".tblCProductosResumen tbody").append(
                                ...
                                '<td class="text-center"><span class="label label-warning">$ ' + $.number(dtm.IMPORTE, 5, '.', ', ') + '</span></td>' +
                                '<td class="tdImporte hide">' + dtm.IMPORTE + '</td>' +
                                '<td class="hide"><button type="button" class="btn btn3d btn-default btn-lg fa-lg btnDeleteRow" onclick="onDeleteRow(this,\'pnlTotalCotizacion\',\'\')" data-toggle="tooltip" data-placement="top" title="" data-original-title="ELIMINAR" ><span class="fa fa-minus"></span></button> </td><td class="chksApproved text-center">' +
...
//                $("#pnlHeadCotizacionUpdate").html("");
                    ...
                    $.each(rows, function (k, dtm) {
                        $(".tblCProductosU tbody").append(
                                ...
                                '<td><button type="button" class="btn btn3d btn-default btn-lg fa-lg" onclick="onDeleteRow(this,\'pnlTotalCotizacionUpdate\',\'pnlOCMessagesUpdate\')" data-toggle="tooltip" data-placement="top" title="" data-original-title="ELIMINAR" ><span class="fa fa-minus"></span></button> </td><td class="tdEstatus"><span class="label label-primary">GUARDADO</span></td></tr>');
                    });
                    //CLICK SELECTED ROW
...
//                console.log(data);
        ...
        $("#mdlNuevoOC #Proveedores").change(function (e) {
            getProductosXProveedor();
...
//            console.log(jqXHR);
                if (data.length === 0) {
                    ...
                    $.each(data, function (k, v) {
                        options = options + '<option value="' + v.ID + '">' + v.Producto + ' ' + v.Marca + ' ($' + v.Precio + ')</option>';
                    });
...
//                    console.log(v.Proveedor);
                    ...
                    $("#mdlNuevoOC #Proveedores").html(options);
...
//    });
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data !== undefined) {
                    ...
                    $("#mdlNuevoOC #Elabora").html(options);
    ...
    function getProductosXProveedor() {
        ...
        var Proveedores = $("#mdlNuevoOC #Proveedores");
        var Productos = $("#mdlNuevoOC #Producto");
        $.ajax({
            url: base_url + 'index.php/ctrlCompras/getProductosXProveedor',
            type: "POST",
            dataType: "JSON",
            data: {
            ...
            if (data !== undefined) {
                $.each(data, function (k, v) {
                    console.log(v);
                    options = options + '<option value="' + v.ID + '">' + v.Producto + ' ($ ' + v.Precio + ')</option>';
                });
                Productos.html(options);
            } else {
                onNotify('<span class="fa fa-exclamation fa-lg"></span>', 'NO SÉ ENCONTRARON PRODUCTOS', 'danger');
            }
        }).fail(function (x, y, z) {
            console.log(x, y, z);
        }).always(function () {
