...
<div class="container">	
    ...
    <?php echo form_open_multipart('controlador3/Planeacion2_5'); ?> 
                    ...
                    <tr>
                        <td> 
                            <div class="col-md-4 col-xs-12">	
                                <div class="col-md-12 col-xs-12">
                                    <label for="1" class="control-label">Medidas de lienzo en crudo</label><br>
                                </div>  
                                <div class="col-md-12 col-xs-12">
                                    <select class="form-control" id="Lienzo" name="Lienzo"   required="required">
                                        <option value="">Selecciona</option>
                                        <?php foreach ($MLienzo as $MLienzo1) { ?>                    
                                            <option value="<?php echo $MLienzo1->id_lienzo; ?>"><?php echo $MLienzo1->dsc_lienzo; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-xs-12">	
                                <div class="col-md-12 col-xs-12">
                                    <label for="2" class="control-label">Medidas(m)</label><br>
                                </div>  
                                <div class="col-md-12 col-xs-12">
                                    <input style="text-transform:uppercase" onkeyup="javascript:this.value = this.value.toUpperCase()"   type="text" class="form-control" name="Medidas" id="Medidas" >
                                </div>
                            </div>
                        </td>
                    </tr>
