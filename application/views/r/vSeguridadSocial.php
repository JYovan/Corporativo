    ...
    <div class="col-md-12 margin-15-top"> 
        <div class="panel panel-primary container-fluid">
            <div class="panel-heading row">
                ...
                <div class="col-md-8"> 
                    <div class="text-center cursor-hand" onclick="onHideFunctions()"><h1>MÓDULO DE GESTIONES REALIZADAS ANTE EL IMSS<span class="fa fa-chevron-up" ></span></h1></div>
                </div>
                ...
                <fieldset>
                    <div class="col-md-12" id="btnAccions">   
                        ...
                        <span  data-toggle="modal" data-easein="swoopIn" data-target="#mdlMovPatronalesBajasTrabajadores" > 
                            <button class="btn btn-king-blue btn-lg" 
                                    data-toggle="tooltip" 
                                    data-placement="bottom" 
                                    title=""  type="button"
                        ...
                        <span  data-toggle="modal" data-easein="swoopIn" data-target="#mdlDeclaracionSueldosYSalarios" > 
                            <button class="btn btn-info btn-lg" 
                                ...
                                <span class="fa fa-flag-checkered fa-3x"></span>
                            </button>
                        </span>
                        ...
                        <span  data-toggle="modal" data-easein="swoopIn" data-target="#mdlTramiteSATIC" > 
                            <button class="btn btn-warning btn-lg" 
                                ...
                                <span class="fa fa-clone fa-3x"></span>
                            </button>
                        </span>
                        ...
                        <span  data-toggle="modal" data-easein="swoopIn" data-target="#mdlRenovarCancelarNPIEYCertificadoDigital" > 
                            <button class="btn btn-indigo btn-lg" 
                                ...
                                <span class="fa fa-bomb fa-3x"></span>
                            </button>
                        </span>
                        ...
                        <span  data-toggle="modal" data-easein="swoopIn" data-target="#mdlIMMS" > 
                            <button class="btn btn-dark btn-lg hide" 
                                    data-toggle="tooltip" 
                                    data-placement="bottom" 
                                    title=""  type="button"
                        ...
                        <button id="btnHistorial" class="btn btn-steel btn-lg" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                        ...
                        <button id="btnAvance" class="btn btn-steel btn-lg disabled" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                        ...
                        <button id="btnRetroceder" class="btn btn-danger btn-lg disabled" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                        ...
                        <span  data-toggle="modal" data-easein="swoopIn" data-target="#mdlAsesoriasTramiteIMSS" > 
                            <button class="btn btn-info btn-lg" 
                                ...
                                <span class="fa fa-assistive-listening-systems fa-3x"></span>
                            </button>
                        </span>
                        ...
                        <span  data-toggle="modal" data-easein="swoopIn" data-target="#mdlGenerarNominaTrabajadores" > 
                            <button class="btn btn-success btn-lg" 
                                ...
                                <span class="fa fa-diamond fa-3x"></span>
                            </button>
                        </span>
                        <button id="btnNominas" class="btn btn-steel btn-lg" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                        ...
                        <button id="btnEditarNomina" class="btn btn-success btn-lg disabled" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                        ...
                        <button id="btnCancelarNomina" class="btn btn-danger btn-lg disabled" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                        ...
                        <button id="btnConcluirNomina" class="btn btn-indigo btn-lg disabled" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
...
<div class="modal fade" id="mdlIMMS" tabindex="-1" role="dialog">
...
<div class="modal fade" id="mdlPatronIMMS" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="mdlNumeroPatronalNPIE" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="mdlConstanciaIMMS" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="mdlConstanciaAutorizacionesIMMS" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="mdlPatronalesIMMSReingresos" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="mdlMovPatronalesSalarios" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="mdlMovPatronalesBajasTrabajadores" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="mdlDeclaracionAnualRiesgosTrabajo" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="mdlAltaPatronalRenaudacionActividades" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="mdlAvisoRegistroPatronal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="mdlDeclaracionSueldosYSalarios" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="mdlAvisoMovAfiliatoriosTrabajadores" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="mdlTramiteSATIC" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="mdlRenovarCancelarNPIEYCertificadoDigital" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="mdlGeneracionMensuaSUAREVEINFONAVIT" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="mdlAclaracionesYCancelacionesAnteElIMMS" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="mdlElaboracionFiniquitos" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="mdlAsesoriasTramiteIMSS" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="mdlGenerarNominaTrabajadores" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="mdlGenerarNominaTrabajadoresU" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="mdlAvance" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
//        $(".btn").tooltip({placement: 'top'}).tooltip('show');
        ...
        mdlAvance.find("#btnGuardar").click(function () {
            ...
            if (sts === stsbefore) {
                mdlAvance.find("#btnGuardar").addClass("disabled");
                ...
                mdlAvance.find("#btnGuardar").removeClass("disabled");
...
//                frm.append('EmpresaT', mdl.find("#Empresa").find("option:selected").text());
        ...
        btnRefresh.click(function () {
            btnAvance.addClass('disabled');
            btnRetroceder.addClass('disabled');
            btnConcluirNomina.addClass("disabled");
            btnCancelarNomina.addClass("disabled");
            btnEditarNomina.addClass("disabled");
            onGetRecords();
        });

        btnHistorial.click(function () {
            btnAvance.removeClass('disabled');
            btnRetroceder.removeClass('disabled');
            btnConcluirNomina.addClass("disabled");
            btnCancelarNomina.addClass("disabled");
            btnEditarNomina.addClass("disabled");
            getHistorial();
        ...
        btnNominas.click(function () {
            btnAvance.addClass("disabled");
            btnConcluirNomina.removeClass("disabled");
            btnEditarNomina.removeClass("disabled");
            btnCancelarNomina.removeClass("disabled");
            getNominas();
        });
