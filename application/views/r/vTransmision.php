        ...
        <div class="col-md-12 margin-15-top">
            <div class="panel panel-primary container-fluid">
                <div class="panel-heading row">
                    ...
                    <div class="col-md-8"> 
                        <div class="text-center cursor-hand" onclick="onHideFunctions()">MÓDULO DE TRANSMISIONES <span class="fa fa-chevron-up" data-toggle="tooltip" data-placement="top" title="" data-original-title="OCULTAR/MOSTRAR BOTONES"></span></div>
                    </div> 
                    ...
                    <fieldset id="fAccions">
                        <div id="btnAccions" align="center" class="col-md-12">
                            <fieldset>
                                ...
                                <button id="btnEditar" class="btn btn3d btn-lg btn-success fa-2x"
                                ...
                                <button id="btnCancelar" class="btn btn3d btn-lg btn-danger fa-2x"
                                        data-toggle="tooltip" data-placement="top" title="" data-original-title="CANCELAR"  ><span class="fa fa-times fa-lg"></span></button>
                                <button id="btnDispersar" class="btn btn3d btn-lg btn-indigo fa-2x "
                                        data-toggle="tooltip" data-placement="top" title="" data-original-title="DISPERSAR">
                                    <span class="fa fa-check fa-lg"></span>
                                </button>
                                <button id="btnBusquedaEspecifica" class="btn btn3d btn-lg btn-emerald fa-2x" data-toggle="tooltip" data-placement="top" title="" data-original-title="BUSQUEDA ESPECIFICA"  >
                                    <span class="fa fa-search fa-lg"></span>
                                </button>
                                <button id="btnMovimientosCancelados" class="btn btn3d btn-lg btn-danger fa-2x "
                                ...
                                <button id="btnDispersiones" class="btn btn3d btn-lg btn-king-blue fa-2x "
                                        data-toggle="tooltip" data-placement="top" title="" data-original-title="TRANSMISIONES DISPERSADAS">
                                    <span class="fa fa-eye fa-lg"></span>
                                </button>
                                <button id="btnEditarDispersion" class="btn btn3d btn-lg btn-brown fa-2x hide"
                                        data-toggle="tooltip" data-placement="top" title="" data-original-title="EDITAR DISPERSION">
                                    <span class="fa fa-eye fa-lg"></span>
                                </button>
                                <button id="btnPagoDispersion" class="btn btn3d btn-lg btn-success fa-2x hide"
                                ...
                                <button id="btnEditarDispersionesPagadas" class="btn btn3d btn-lg btn-success fa-2x hide"
                                        data-toggle="tooltip" data-placement="top" title="" data-original-title="EDITAR PAGO DE DISPERSION">
                                    <span class="fa fa-money fa-lg"></span>
                                </button>

                                <button id="btnCancelarPagoDispersion" class="btn btn3d btn-lg btn-danger fa-2x hide"
                                ...
                                <button id="btnHistorialDePagosXDispersion" class="btn btn3d btn-lg btn-dark fa-2x hide"
                                        data-toggle="tooltip" data-placement="top" title="" data-original-title="HISTORIAL DE PAGOS (DISPERSION)">
                                    <span class="fa fa-text-width fa-lg"></span>
                                </button>
                                <button id="btnDispersionAcumulada" class="btn btn3d btn-lg btn-dark fa-2x"
                            ...
                            <div id="dBusquedaEspecifica" class="hide">
                                <fieldset>
                                    <form id="fBusquedaEspecifica">
                                        ...
                                        <div class="col-md-2">
                                            <button type="button" class="btn btn3d btn-lg btn-indigo fa-2x" id="btnBuscar" name="btnBuscar"><span class="fa fa-search fa-lg"></span></button>
                                        </div>
                                    </form>
                                </fieldset>
                            </div>
                            ...
                            <div id="sDispersiones" class="hide">
                                <div class="col-md-4"><label for="">PROYECTO</label><select id="Proyecto" name="Proyecto" class="form-control"></select></div>
                                ...
                                <div class="col-md-2"><button type="button" id="btnBuscarDispersiones" class="btn btn3d btn-lg btn-king-blue" data-toggle="tooltip" data-placement="top" title="" data-original-title="BUSCAR"><span class="fa fa-check fa-2x"></span></button></div>
                            </div>
                        </div> 
                    </fieldset> 
                    <fieldset id=""> 
...
<div id="mdlModificar" class="modal animated bounceInDown"  data-easein="swoopIn"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div id="mdlDispersar" class="modal animated bounceInDown"  data-easein="swoopIn"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div id="mdlCancelar" class="modal animated bounceInDown"  data-easein="swoopIn"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <form id="fCancelar" type="post" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <button id="btnClose" type="button" class="btn btn-default" data-dismiss="modal"><span class="fa fa-times fa-3x"></span></button>
                    <button id="btnSave" name="btnSave" type="button" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="" data-original-title="CANCELAR DE TODOS MODOS"><span class="fa fa-check fa-3x"></span></button>
                </div>
            </form> 
        </div>
    </div>
...
<div id="mdlDispersarU" class="modal animated bounceInDown"  data-easein="swoopIn"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div id="mdlPagoDispersado" class="modal animated bounceInDown"  data-easein="swoopIn"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div id="mdlPagoDispersadoU" class="modal animated bounceInDown"  data-easein="swoopIn"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
