    ...
    <div class="col-md-12 margin-15-top">
        <div class="panel panel-primary container-fluid">
            <div class="panel-heading row">
                ...
                <div class="col-md-8"> 
                    <div class="text-center cursor-hand" onclick="onHideFunctions()"><h3>MÓDULO PRECIOS DEL CEMENTO<span class="fa fa-chevron-up" ></span></h3></div>
                </div>
            ...
            <div class="panel-body">
                <fieldset  align="center">
                    <div class="col-md-12" id="btnAccions">   
                        ...
                        <button id="btnEdit" class="btn btn-success btn-lg" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                        ...
                        <button id="btnEliminar" class="btn btn-danger btn-lg" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                        ...
                        <button id="btnBuscar" class="btn btn-a-orange btn-lg" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                        ...
                        <button id="btnComercializador" class="btn btn-indigo btn-lg" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                        ...
                        <button id="btnEditarComercializador" class="btn btn-indigo btn-lg" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                        ...
                        <button id="btnVerComercializador" class="btn btn-indigo btn-lg" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                ...
                <div class="hide" id="dSearch"> 
                    <form id="fSearch">
                        ...
                        <div class="col-md-2">
                            <button type="button" id="btnBuscarAhora" class="btn btn3d btn-indigo btn-lg"><span class="fa fa-search fa-3x"></span></button>
                        </div>
                    </form>
                </div>
...
<div class="modal fade" id="mdlUpdate" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn-lg" data-dismiss="modal"><span class="fa fa-times fa-2x"></span></button>
                <button class="btn btn-lg btn-success btn-lg" type="button" id="btnSave" name="btnSave"  data-toggle="tooltip" data-placement="top" title="" data-original-title="GUARDAR" ><span class="fa fa-check fa-2x"></span></button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div>
