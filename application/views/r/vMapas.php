<div class="row"> 
    ...
    <div class="col-md-3 col-xs-7 inside-map">
        <select class="form-control" id="ID" name="ID" placeholder="PROYECTO">
            <option value=""></option>
        </select>
    </div> 
    <div class="col-md-1 col-xs-1 inside-map">
        <button id="btnAdd" name="btnAdd" class="btn btn3d btn-info"  data-toggle="tooltip" data-placement="right" title="" data-original-title="NUEVO" ><span class="fa fa-plus fa-2x"></span></button>
        <button id="btnEdit" name="btnEdit" class="btn btn3d btn-success"  data-toggle="tooltip" data-placement="right" title="" data-original-title="EDITAR" ><span class="fa fa-pencil fa-2x"></span></button>
        <button id="btnRefresh" name="btnRefresh" class="btn btn3d btn-warning"  data-toggle="tooltip" data-placement="right" title="" data-original-title="REFRESCAR" ><span class="fa fa-refresh fa-2x"></span></button>
        <button id="btnRemove" name="btnRemove" class="btn btn3d btn-danger"  data-toggle="tooltip" data-placement="right" title="" data-original-title="ELIMINAR" ><span class="fa fa-minus fa-2x"></span></button>
        <button id="btnAddD" name="btnAddD" class="btn btn3d btn-indigo"  data-toggle="tooltip" data-placement="right" title="" data-original-title="NUEVO PREDIO" ><span class="fa fa-plus fa-2x"></span></button>
        <button id="btnEditD" name="btnAddD" class="btn btn3d btn-emerald"  data-toggle="tooltip" data-placement="right" title="" data-original-title="EDITAR PREDIO" ><span class="fa fa-pencil fa-2x"></span></button>
        <button id="btnBack" name="btnBack" class="btn btn3d btn-dark"  data-toggle="tooltip" data-placement="right" title="" data-original-title="MENU PRINCIPAL" ><span class="fa fa-arrow-left fa-2x"></span></button>
    </div> 
        ...
        <div class="modal-content">
            ...
            <form id="fNuevo" type="post" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <button id="btnClose" type="button" class="btn btn-default"><span class="fa fa-times fa-3x"></span></button>
                    <button id="btnSave" name="btnSave" type="button" class="btn btn-success" ><span class="fa fa-check fa-3x"></span></button>
                </div>
            </form> 
        </div>
    </div>
            ...
            <form id="fNuevoD" type="post" enctype="multipart/form-data">
                <div class="modal-body">
                    <fieldset>
                        ...
                        <div class="col-md-12">
                            <button class="btn btn3d btn-success inside-map-extv2" id="btnAddCoor">
                        ...
                        <input type="file" id="Portada" name="Portada" class="btn btn3d btn-indigo hide" >
                    </fieldset>
                </div>
                <div class="modal-footer">
                    <button id="btnClose" type="button" class="btn btn-default"><span class="fa fa-times fa-3x"></span></button>
...
//                    console.log(c)
                    ...
                    var infowindow;
                    var contentString = '<div id="" align="center" class="col-md-12">' +
                            '<img src="' + (base_url + v.PORTADA) + '" class="image-responsive" width="50%" height="50%">' +
                            '</div>'+
                            '<div class="col-md-6">\n\
                            <p>NÚMERO DE VIVIENDAS: </p><p><span class="label label-emerald">' + v.NumeroViviendas + '</span></p>' +
                            '<p>CASAS NO VENDIDAS: </p><p><span class="label label-danger">' + v["NO VENDIDAS"] + '</span></p>' +
                            ...
                            '</div><div class="col-md-6">\n\
                             <p>TOTAL EN TERRENOS TRANSMITIDOS : </p><p><span class="label label-indigo"> ' + ((v["TOTAL TERRENOS"] !==null && v["TOTAL TERRENOS"] !== 'null')?v["TOTAL TERRENOS"]:"$ 0.0")+ '</span></p>'+
                            '<p>TOTAL EN RENDIMIENTOS TRANSMITIDOS : </p><p><span class="label label-indigo"> ' + ((v["TOTAL RENDIMIENTOS"] !==null && v["TOTAL RENDIMIENTOS"] !== 'null')?v["TOTAL RENDIMIENTOS"]:"$ 0.0") + '</span></p>'+
                            '<p>TOTAL EN INGRESOS TRANSMITIDOS :</p><p><span class="label label-indigo"> ' +((v["TOTAL TRANSMITIDO"] !==null && v["TOTAL TRANSMITIDO"] !== 'null')?v["TOTAL TRANSMITIDO"]:"$ 0.0")   + '</span></p>'+
                            '<p>TOTAL PAGADO: </p><p><span class="label label-king-blue"> ' + ((v["TOTAL PAGADO"] !==null && v["TOTAL PAGADO"] !== 'null')?v["TOTAL PAGADO"]:"$ 0.0")+ '</span></p>'
                           +'</div>';
//                          + '<div id="" align="center" class="col-md-6"><ul class="list-group">'+
//                           '<li class="list-group-item"><span class="badge label-emerald">' + v.NumeroViviendas + '</span>NÚMERO DE VIVIENDAS: </li>'+
//                           '<li class="list-group-item"><span class="badge label-danger">' + v["NO VENDIDAS"] + '</span>CASAS NO VENDIDAS: </li>'+
//                           '<li class="list-group-item"><span class="badge label-warning">' + v.TRANSMITIDAS + '</span>CASAS TRANSMITIDAS: </li>'+
//                           '<li class="list-group-item"><span class="badge label-success">' + v.DISPERSADAS + '</span>CASAS DISPERSADAS: </li>'+
//                           '<li class="list-group-item"><span class="badge label-king-blue">' + v.PAGADAS + '</span>CASAS PAGADAS: </li>'+
//                           '</ul></div>'+
//                           '<div id="" align="center" class="col-md-6"><ul class="list-group">'+
//                           '<li class="list-group-item"><span class="badge label-emerald">' + v.NumeroViviendas + '</span>TOTAL EN TERRENOS TRANSMITIDOS: </li>'+
//                           '<li class="list-group-item"><span class="badge label-danger">' + v["NO VENDIDAS"] + '</span>TOTAL EN RENDIMIENTOS TRANSMITIDOS: </li>'+
//                           '<li class="list-group-item"><span class="badge label-warning">' + v.TRANSMITIDAS + '</span>TOTAL EN INGRESOS TRANSMITIDOS : </li>'+
//                           '<li class="list-group-item"><span class="badge label-success">' + v.DISPERSADAS + '</span>CASAS DISPERSADAS: </li>'+
//                           '<li class="list-group-item"><span class="badge label-king-blue">' + v.PAGADAS + '</span>CASAS PAGADAS: </li>'+
//                           '</ul></div>';
