    ...
    <div class="col-md-12 margin-15-top-bottom">  
        ...
        <div class="panel panel-primary container-fluid">
            <div class="panel-heading row">
                ...
                <div class="col-md-8"> 
                    <div class="text-center cursor-hand" onclick="onHideFunctions()"><h3>MÓDULO DE TRÁMITE DE FACTURAS <span class="fa fa-chevron-up" ></span></h3></div>
                </div>
                    ...
                    <div id="btnAccions" align="center" class="col-md-12">
                        <fieldset>
                            <span  data-toggle="modal" data-easein="swoopIn" data-target="#mdlNuevo" >
                                <button id="btnNuevo" class="btn btn-lg btn-default fa-2x"  data-toggle="tooltip" data-placement="top" title="" data-original-title="NUEVO"><span class="fa fa-plus fa-lg"></span></button>
                                    </span>
                            <button id="btnEditarTramiteFactura" class="btn btn3d btn-lg btn-default fa-2x"
                                    data-toggle="tooltip" data-placement="bottom" title="" data-original-title="MODIFICAR"  ><span class="fa fa-pencil fa-lg"></span></button>
                            <button id="btnReCargarTramiteFactura" class="btn btn3d btn-lg btn-default fa-2x"
                                    data-toggle="tooltip" data-placement="top" title="" data-original-title="REFRESCAR"  ><span class="fa fa-refresh fa-lg"></span></button>
                            <button id="btnCancelarFactura" class="btn btn3d btn-lg btn-default fa-2x"
                                    data-toggle="tooltip" data-placement="bottom" title="" data-original-title="CANCELAR FACTURA"  ><span class="fa fa-times fa-lg"></span></button>
                            <button id="btnFacturasCanceladas" class="btn btn3d btn-lg btn-default fa-2x hide"
                            ...
                            <button id="btnReporteAcumuladoGeneral" class="btn btn3d btn-lg btn-default fa-2x"
                            ...
                            <button id="btnReporteTramiteFactura" class="btn btn3d btn-lg btn-default fa-2x"
                            ...
                            <span  data-toggle="hide" data-easein="swoopIn" data-target="#content-busqueda" >
                                <button id="btnBusquedaEspecifica" class="btn btn3d btn-lg btn-default fa-2x" data-toggle="tooltip" data-placement="top" title="" data-original-title="BUSQUEDA ESPECIFICA"  >
                                    <span class="fa fa-search fa-lg"></span>
                                </button> 
                            </span>
                            <button id="btnNC" class="btn btn3d btn-lg btn-default fa-2x"
                    ...
                    <div id="content-busqueda" class="col-md-12 ui-widget-content hide ztop">
                        <form id="frmBusquedaEspecifica">
                            ...
                            <div class="col-md-1" align="center" > 
                                <button id="btnReporteBusqueda" class="btn btn3d btn-lg btn-default"
                                        data-toggle="tooltip" data-placement="top" title="" data-original-title="BUSCAR" type="button" >
                                    <span class="fa fa-search fa-3x"></span>
                                </button>
                            </div>
                            <div class="col-md-1" align="center" > 
                                <button id="btnResetBusqueda" class="btn btn3d btn-lg btn-default"
                            ...
                            <div class="col-md-12" align="center" >
                                ...
                                <button id="btnCRIndividual" class="btn btn3d btn-lg btn-default" data-toggle="tooltip" data-placement="top" title="" data-original-title="CONTRA RECIBO"  type="button" >
                                    <span class="fa fa-exclamation fa-building-black fa-3x"></span>
                                </button> 
                                <button id="btnCROBRA" class="btn btn3d btn-lg btn-default " data-toggle="tooltip" data-placement="bottom" title="" data-original-title="CONTRA RECIBO (OBRA)"  type="button" >
                                    <span class="fa fa-building fa-3x fa-building-black"></span>
                                </button>  
                                <button id="btnCRMATERIAL" class="btn btn3d btn-lg btn-default " data-toggle="tooltip" data-placement="top" title="" data-original-title="CONTRA RECIBO (MATERIALES)"  type="button" >
                                    <span class="fa fa-puzzle-piece fa-puzzle-piece-invert fa-3x"></span>
                                </button>  
                                <button id="btnReportesFacturasSinAvanzar" class="btn btn3d btn-lg btn-default" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="CONTRA RECIBO GENERAL(REGISTRADA)"  type="button" >
                                    <span class="fa fa-exclamation fa-invert-negative fa-3x"></span>
                                </button>
                                <button id="btnReportesFacturasSinAvanzarOBRA" class="btn btn3d btn-lg btn-default" data-toggle="tooltip" data-placement="top" title="" data-original-title="CONTRA RECIBO GENERAL (REGISTRADA)(OBRA)"  type="button" >
                                    <span class="fa fa-building fa-invert-negative fa-3x"></span>
                                </button>
                                <button id="btnReportesFacturasSinAvanzarMATERIAL" class="btn btn3d btn-lg btn-default" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="CONTRA RECIBO GENERAL (REGISTRADA)(MATERIAL)"  type="button" >
                                    <span class="fa fa-puzzle-piece fa-invert-negative fa-3x"></span>
                                </button>  


                                <button id="btnReportesFacturas" class="btn btn3d btn-lg btn-default" data-toggle="tooltip" data-placement="top" title="" data-original-title="CONTRA RECIBO GENERAL(EN ELABORACIÓN DE FORMA DE PAGO)"  type="button" >
                                    <span class="fa fa-exclamation fa-3x"></span>
                                </button> 
                                <button id="btnReportesFacturasOBRA" class="btn btn3d btn-lg btn-default" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="CONTRA RECIBO GENERAL (EN ELABORACIÓN DE FORMA DE PAGO)(OBRA)"  type="button" >
                                    <span class="fa fa-building fa-3x"></span>
                                </button>
                                <button id="btnReportesFacturasMATERIAL" class="btn btn3d btn-lg btn-default" data-toggle="tooltip" data-placement="top" title="" data-original-title="CONTRA RECIBO GENERAL (EN ELABORACIÓN DE FORMA DE PAGO)(MATERIAL)"  type="button" >
                                    <span class="fa fa-puzzle-piece fa-3x"></span>
                                </button>

                                <button id="btnAcumuladoPorProveedor" class="btn btn3d btn-lg btn-default " data-toggle="tooltip" data-placement="bottom" title="" data-original-title="ACUMULADO ESPECÍFICO"  type="button" >
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="col-md-3">
                    <div class="panel panel-success" id="pnlFacturasPagadas">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-xs-3">
...
<div id="mdlNuevo" class="modal animated fadeIn"  data-easein="swoopIn"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg fullscreen" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h2 class="modal-title text-center" id="myModalLabel"> <span class="fa fa-database fa-lg"></span> REGISTRO DE FACTURA PARA TRÁMITE DE PAGO </h2>
            </div>
            <form id="fTramiteFactura" type="post" enctype="multipart/form-data">
                <div class="modal-body">
                    <fieldset>
                        <div class="col-md-3 hide">
                            ...
                            <input type="text" id="IdTramiteFactura" name="IdTramiteFactura" class="form-control" readonly="" required="" value="0"></div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-2">
                            <button type="button" class="btn btn3d btn-default" id="btnAddNCXF" name="btnAddNCXF" data-toggle="tooltip" data-placement="top" title="" data-original-title="APLICAR NOTA"  ><span class="fa fa-check fa-3x"></span></button>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button id="btnRegistrarTramiteFactura" type="button" class="btn btn-default"  data-toggle="tooltip" data-placement="top" title="" data-original-title="GUARDAR"><span class="fa fa-check fa-3x"></span></button>
                    <button id="btnActualizarTramiteFactura" type="button" class="btn btn-default hide"><span class="fa fa-refresh fa-3x"></span></button>
                    <button id="btnActualizarTramiteFacturaProgress" type="button" class="btn btn-default hide"><span class="fa fa-refresh fa-spin fa-3x"></span></button>
                    <!--<button id="btnUploadImage" type="submit" name="btnUploadImage" class="btn btn-default">SUBIR IMAGEN</button>-->
                </div>
...
//                        var file = fbutton[0].files[0];
//                        var imageType = /image.*/;
//                        if (file.type.match(imageType)) {
//                            var reader = new FileReader();
//                            reader.onload = function (e) {
//                                rArchivo.html('<img src="' + reader.result + '" width=\"450\" height=\"600\" ">');
//                                console.log('ARCHIVO ADJUNTO CON EXITO');
//                            };
//                            reader.readAsDataURL(file);
//                        } else {
//                            rArchivo.html("LA API DE FILEREADER NO ES CAPAZ DE EJECUTARSE EN ESTE NAVEGADOR, UTILIZA CHROME O FIREFOX!");
//                        }
//                    });
                    fbutton.change(function () {
                        var imageType = /image.*/;
...
<div id="mdlRFPTDP" class="modal animated fadeIn" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
...
<div id="mdlRevision" class="modal animated fadeIn" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                ...
                <div class="modal-body">
                    <fieldset>
                        ...
                        <div class="col-xs-6 col-sm-2">
                            <button type="button" class="btn btn3d btn-default" id="btnAddNCXFR" name="btnAddNCXFR" data-toggle="tooltip" data-placement="top" title="" data-original-title="APLICAR NOTA"  ><span class="fa fa-check fa-3x"></span></button>
                        </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="fa fa-times fa-3x"></span></button>
                <button id="btnSave" type="button" class="btn btn-default" > <span class="fa fa-check fa-3x"  data-toggle="tooltip" data-placement="top" title="" data-original-title="GUARDAR" ></span></button>
            </div>
        </div>
    </div>
</div>
...
<div id="mdlADFPEDFDP" class="modal animated fadeIn" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
...
<div id="mdlAutorizacion" class="modal animated fadeIn" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="fa fa-times fa-3x"></span></button>
                <button id="btnSave" type="submit" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="" data-original-title="GUARDAR"> <span class="fa fa-check fa-3x" ></span></button>
            </div>
        </div>
    </div>
</div>
...
<div id="mdlPagoFactura" class="modal animated fadeIn" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    ...
                    <div class="tab-pane fade active in" id="rPAY">
                        <form id="fObservacionADMPPDF">
                            <fieldset>
                                ...
                                <div class="col-md-12" align="center">
                                    <!--<button id="btnAddNotaDeCredito" class="btn btn3d btn-default" >AGREGAR NOTA DE CRÉDITO</button>-->
                                </div>
                                <div class="col-md-12">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="fa fa-times fa-3x"></span></button>
                <button id="btnSave" type="button" class="btn btn-default" data-loading-text="GUARDANDO..." autocomplete="off"> <span class="fa fa-check fa-3x"></span></button>
<!--                <button id="btnGuardarADMPPDF" type="button" class="btn btn-primary disabled" data-loading-text="GUARDANDO..." autocomplete="off"> <span class="fa fa-save fa-3x"></span></button>
                ...
                <button id="btnNotaDeCredito" type="button" class="btn btn3d btn-default hide" ><span class="fa fa-check fa-3x"></span></button>
...
<div id="mdlOBTF" class="modal animated fadeIn" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div id="mdlPreview" class="modal fade"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg fullscreen" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="fa fa-times fa-lg"></span></button> 
            </div>
        </div>
    </div>
</div>
...
<div id="mdlNotaDeCredito" class="modal animated fadeIn" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="fa fa-times fa-3x"></span></button>
                <button id="btnSave" type="button" class="btn btn-default" data-loading-text="GUARDANDO..." autocomplete="off" data-toggle="tooltip" data-placement="top" title="" data-original-title="GUARDAR" > <span class="fa fa-check fa-3x"></span></button>
            </div>
        </div>
    </div>
</div>
...
<div id="mdlNotaDeCreditoV" class="modal animated fadeIn" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<script>
    ...
    $(document).ready(function () {
        master_url = base_url + 'index.php/ctrlTramiteFactura/';
//        call = $.Callbacks();
//        call.add(onLoad());
//        call.fire();
            ...
            if (temp !== undefined && temp !== null && temp !== "" && temp > 0) {
                ...
                $.ajax({
                    ...
                    if (dtm !== undefined) {
                        ...
                        onNotify('<span class="fa fa-exclamation fa-lg"></span>', 'OCURRIO UN PROBLEMA MIENTRAS SE OBTENIAN LOS DATOS, COMUNIQUESE CON EL ADMINISTRADOR DEL SISTEMA.', 'danger');
                    }
...
//                temp = parseInt($(dtm[0]).find("span")[0] !== undefined ? $(dtm[0]).find("span")[0].innerText : dtm[0]);
        ...
        mdlAutorizacion.on('show.bs.modal', function () {
            ...
            $.ajax({
                url: base_url + 'index.php/ctrlTramiteFactura/getRecordsHistoryByID',
                type: "POST",
                dataType: "JSON",
                data: {
                    ID: temp
...
//        $("#tblObservacionesRevisadas").html(data); 
        ...
        mdlPagoFactura.find("#btnNotaDeCredito").click(function () {
            ...
            $.ajax({
                ...
                if (parseInt(data) > 0) {
                    onGetRecords("tblTramiteFactura", base_url + "index.php/ctrlTramiteFactura/onLoad", 1, "rTramiteFactura", "msgTramiteFactura", "NO SE ENCONTRARON REGISTROS");
...
//    });
        ...
        $("#btnRegistrarTramiteFactura").on('click', function () {
            ...
            $.ajax({
                url: base_url + 'index.php/ctrlTramiteFactura/onBeforeRegisterCheckFactura',
                type: "POST",
                dataType: "JSON",
                data: {
                    ID: $("#NumeroFactura").val()
                }
            }).done(function (data, x, jq) {
                if (parseInt(data) === 1) {
                    ...
                    dataf.append('PAGADA', ($('#fTramiteFactura').find('#Pagada')[0].checked) ? 1 : 0);
                    var detalleNC = [];
                    var rows_in = tblNotasDeCreditoXFactura.find("tbody > tr").length;
                    var tnc = 0.0;
                    if (rows_in > 0) {
                    ...
                    $.ajax({
                        url: base_url + 'index.php/ctrlTramiteFactura/onAdd',
                        type: "POST",
                        cache: false,
                        contentType: false,
                        processData: false,
        ...
        $("#btnActualizarTramiteFactura").on('click', function () {
            ...
            $.ajax({
                url: base_url + 'index.php/ctrlTramiteFactura/onBeforeUpdate',
                type: "POST",
                cache: false,
                contentType: false,
                processData: false,
        ...
        $("#btnReporteAcumuladoGeneral").click(function () {
            ...
            $.ajax({
                url: base_url + 'index.php/ctrlTramiteFactura/getSaldosGenerales',
                type: "POST"
            }).done(function (data, x, jq) {
                console.log(data);
                window.open(data, '_blank');
//            $("#mdlPreview").modal('toggle');
//            $("#result-preview").html('<hr> <embed src="' + data + '" type="application/pdf" width="90%" height="800px"' +
//                    ' pluginspage="http://www.adobe.com/products/acrobat/readstep2.html">');
        ...
        $("#btnAcumuladoPorProveedor").click(function () {
            if ($("#cmbProveedorFactura").val() !== undefined && $("#cmbProveedorFactura").val() !== '' || $("#cmbEmpresaBusqueda").val() !== undefined && $("#cmbEmpresaBusqueda").val() !== '') {
                ...
                $.ajax({
                    url: base_url + 'index.php/ctrlTramiteFactura/getSaldosGeneralesByEmpresaAndProveedor',
                    type: "POST",
                    data: {
                    ...
                    console.log(data);
//                $("#mdlPreview").modal('toggle');
//                $("#result-preview").html('<hr> <object  data="' + data + '" width="90%" height="800px">');
                    window.open(data, '_blank');
                }).fail(function (x, y, z) {
                    console.log(x, y, z);
                }).always(function () {
                ...
                $.notify({
                    ...
                    animate: {
                        enter: 'animated fadeInIn',
                        exit: 'animated fadeInOut'
                    }
                });
            }
        });
        ...
        $("#fObservacionRDFPTDP").submit(function (e) {
            ...
            if (parseInt($("#ObservacionesYN").val()) === 2) {
                ...
                onNotify('<span class="fa fa-cog fa-lg fa-spin"></span>', 'SE HA AVANZADO EL REGISTRO A REVISIÓN', 'success');
            } else {
        ...
        /*METODO QUE GUARDA EL AVANCE DE LA FACTURA A PAGO PARCIAL O A ELABORACION DE FORMA DE PAGO*/
        mdlPagoFactura.find("#btnSave").click(function () {
            HoldOn.open({
                theme: "sk-bounce",
                message: "CARGANDO... POR FAVOR ESPERE"
            });
            ...
            $.ajax({
                type: "POST",
                url: base_url + 'index.php/ctrlTramiteFactura/onPagar',
                data: formdata
            }).done(function (data, x, jq) {
                console.log(data);
                $("#btnReCargarTramiteFactura").trigger('click');
        ...
        $("#btnReportesFacturasOBRA").click(function (e) {
            ...
            console.log($("#cmbEmpresaBusqueda").val());
            $.ajax({
                url: base_url + 'index.php/ctrl' + doc + '/onCreatePDFByIDOBRA',
                type: "POST",
                data: {
                    ID: $("#cmbEmpresaBusqueda").val(),
                    FECHAINICIO: $("#FechaInicioH").val(),
        ...
        $("#btnReportesFacturasMATERIAL").click(function (e) {
            ...
            console.log($("#cmbEmpresaBusqueda").val());
            $.ajax({
                url: base_url + 'index.php/ctrl' + doc + '/onCreatePDFByIDOBRAMATERIAL',
                type: "POST",
                data: {
                    ID: $("#cmbEmpresaBusqueda").val(),
                    FECHAINICIO: $("#FechaInicioH").val(),
        ...
        $("#btnReportesFacturasSinAvanzarOBRA").click(function (e) {
            ...
            $.ajax({
                url: base_url + 'index.php/ctrl' + doc + '/onCreatePDFByIDSAOBRA',
                type: "POST",
                data: {
                    ID: $("#cmbEmpresaBusqueda").val(),
                    FECHAINICIO: $("#FechaInicioH").val(),
        ...
        $("#btnReportesFacturasSinAvanzarMATERIAL").click(function (e) {
            ...
            $.ajax({
                url: base_url + 'index.php/ctrl' + doc + '/onCreatePDFByIDSAMATERIAL',
                type: "POST",
                data: {
                    ID: $("#cmbEmpresaBusqueda").val(),
                    FECHAINICIO: $("#FechaInicioH").val(),
...
//        console.log('CR POR PROVEEDOR...');
            ...
            $.ajax({
                url: base_url + 'index.php/ctrl' + doc + '/getContraReciboObra',
                type: "POST",
                data: {
                    ID: $("#cmbEmpresaBusqueda").val(),
                    FECHAINICIO: $("#FechaInicioH").val(),
...
//        console.log('CR POR PROVEEDOR...');
            ...
            $.ajax({
                url: base_url + 'index.php/ctrl' + doc + '/getContraReciboMateriales',
                type: "POST",
                data: {
                    ID: $("#cmbEmpresaBusqueda").val(),
                    FECHAINICIO: $("#FechaInicioH").val(),
        ...
        $("#btnCancelarFactura").click(function () {
            if (temp !== undefined && temp !== null && temp !== 0 && temp !== '') {
                $.ajax({
                    url: base_url + 'index.php/ctrlTramiteFactura/onCancelarFactura',
                    type: "POST",
                    data: {
                        ID: temp
                    }
                    ...
                    console.log(data);
                    if (parseInt(data) === 1) {
                        onNotify('<span class="fa fa-check fa-lg"></span>', 'FACTURA CANCELADA', 'danger');
                    } else {
                        onNotify('<span class="fa fa-exclamation fa-lg"></span>', 'NO SE HA PODIDO CANCELAR LA FACTURA', 'danger');
                    }
                });
                onRefreshData();
            } else {
...
//                console.log(this)
    ...
    function getProyectos() {
        $.ajax({
            url: base_url + "index.php/ctrlTramiteFactura/getProyectos",
            type: "POST",
            dataType: "JSON"
        }).done(function (data) {
//        console.log(data);
...
//                console.log(data[x].ID);
    ...
    function getProveedores() {
        $.ajax({
            url: base_url + "index.php/ctrlTramiteFactura/getProveedores",
            type: "POST",
            dataType: "JSON"
        }).done(function (data) {
//        console.log(data);
...
//                console.log(data[x].ID);
    ...
    function getActividades() {
        $.ajax({
            url: base_url + "index.php/ctrlTramiteFactura/getActividades",
            type: "POST",
            dataType: "JSON"
        }).done(function (data) {
//        console.log(data);
...
//                console.log(data[x].ID);
    ...
    function getEmpresas() {
        $.ajax({
            url: base_url + "index.php/ctrlTramiteFactura/getEmpresas",
            type: "POST",
            dataType: "JSON"
        }).done(function (data) {
            var options = "<option></option>";
...
//                console.log(data[x].ID);
    ...
    function getInformacionAdicional() {
        $.ajax({
            url: base_url + "index.php/ctrlTramiteFactura/getInformacionAdicional",
            type: "POST",
            dataType: "JSON"
        }).done(function (data, x, jq) {
            console.log(data);
    ...
    function onCreateReport(modal_messages, target_messages, content_message) {
        ...
        if (temp !== undefined && temp !== null && temp !== 0 && temp !== '') {
            $.ajax({
                ...
                console.log(data);
                $.ajax({
                    url: base_url + "index.php/ctrl" + doc + "/onCreatePDF",
                    type: "POST",
                    data: {
...
//    console.log(data);
        $("#IdTramiteFactura").val(data.ID);
        $("#Folio").val(data.FOLIO);
        $("#Fecha").val(data.FECHA);
        $("#Hora").val(data.HORA);
        $("#Empresa").val(data.EMPRESA);
        $("#Empresa").select2("val", data.EMPRESA);
        /*MAS ADELANTE SE VA A CAMBIAR YA QUE LOS NOMBRES ESTAN MAL*/
        $("#ModeloNegocio").select2("val", data.ACTIVIDAD);
        $("#Actividad").select2("val", data["PROYECTO"]);
        /*ESTOS 2 NOMBRES ANTERIORES ESTAN MAL, SE DEJO EN SU MOMENTO ASÍ PORQUE YA URGIA Y HUBO CAMBIO DE ULTIMO MINUTO*/
        $("#NumeroDeContrato").val(data["NUMERO DE CONTRATO"]);
        $("#Proveedor").val(data.PROVEEDOR);
        $("#Proveedor").select2("val", data.PROVEEDOR);
        $("#NumeroFactura").val(data["NUMERO DE FACTURA"]);
        $("#Importe").val(data.IMPORTE);
        $("#OrdenDeCompraRef").val(data["ORDEN DE COMPRA"]);
        $("#Observacion").val(data.OBSERVACION);
        $("#Receptor").val(data.RECEPTOR);
        $("#Receptor").select2("val", data.RECEPTOR);
        $("#FechaFactura").val(data["FECHA FACTURA"]);
//    $("#frtImagen").html("<div class='img-ajax-upload'><img id='trtImagen' src='" + data.RTIMAGEN + "' /></div>");
        ...
        if (data.RTIMAGEN !== null && data.RTIMAGEN !== undefined && data.RTIMAGEN !== '') {
            ...
            console.log(ext);
            if (ext === "gif" || ext === "jpg" || ext === "png") {
                $("#frtImagen").html("<hr><img id='trtImagen' src='" + data.RTIMAGEN + "' class ='img-responsive'/>");
            }
            if (ext === "PDF" || ext === "Pdf" || ext === "pdf") {
                $("#frtImagen").html('<hr> <embed src="' + data.RTIMAGEN + '" type="application/pdf" width="90%" height="800px"' +
                        ' pluginspage="http://www.adobe.com/products/acrobat/readstep2.html">');
            }
        } else {
            $("#frtImagen").html('<h3>NO EXISTE ARCHIVO ADJUNTO</h3>');
        }

        $("#rtImagenText").val(data.RTIMAGEN);
    }
...
//        $("#btnGuardarADMPPDF").removeClass("disabled");
    ...
    function onSearchByTramiteFactura() {
        ...
        dtm.push(fpago);
        dtm.push(pro);
        onGetRecordsByDate("tblTramiteFactura", base_url + "index.php/ctrlTramiteFactura/onLoad", 13, "rTramiteFactura", "msgTramiteFactura", "NO SE ENCONTRARON REGISTROS", dtm);
    }
    ...
    function getNotasDeCreditoXFacturas() {
        ...
        $.ajax({
            url: base_url + "index.php/ctrlTramiteFactura/getNotasDeCreditoXFacturas",
            type: "POST",
            dataType: "JSON"
        }).done(function (data) {
