        ...
        <div class="col-md-12 margin-15-top">
            <div class="panel panel-primary container-fluid">
                ...
                <div class="panel-body">
                    <div align="center"> 
                        <button id="btnNuevo" class="btn btn-info btn-lg" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                        ...
                        <button id="btnSembradoManzanas" class="btn btn-danger btn-lg" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                        ...
                        <button id="btnVerSembradoManzanas" class="btn btn-danger btn-lg" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                        ...
                        <button id="btnSembradoLotes" class="btn btn-indigo btn-lg" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                        ...
                        <button id="btnVerSembradoLotes" class="btn btn-indigo btn-lg" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                        ...
                        <button id="btnSembradoViviendas" class="btn btn-king-blue btn-lg" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                        ...
                        <button id="btnVerSembradoViviendas" class="btn btn-king-blue btn-lg" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
...
//                    $("#btnEditar").trigger("click");
    ...
    function getInmuebleRegistro()
    {
        ...
        $.ajax({
            ...
            var options = "<option></option>";
            $.each(data, function (k, v) {
                options = options + '<option value="' + v.ID + '">' + v.PROPIETARIO + '</option>';
            });
