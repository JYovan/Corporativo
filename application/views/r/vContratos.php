                    ...
                    <fieldset id="fAccions">
                        <div id="btnAccions" align="center" class="col-md-12">
                            <fieldset>
                                ...
                                <!--                                <button id="btnCancelarPago" class="btn btn3d btn-lg btn-danger fa-2x"
                                                                ...
                                                                <button id="btnConsultarSaldos" class="btn btn3d btn-lg btn-indigo fa-2x"
    ...
    $(document).ready(function () {
        ...
        btnModificar.click(function () {
            ...
            var encabezado = {
                ...
                SinIVA: (mdlModificar.find("#SINIVA")[0].checked),
