            ...
            <div class="panel panel-primary container-fluid">
                ...
                <div class="panel-body">
                    <div align="center">
                        ...
                        <button id="btnPrecios" class="btn btn-indigo btn-lg" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                        ...
                        <button id="btnEditarPrecio" class="btn btn-a-orange btn-lg disabled" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                        ...
                        <button id="btnAsignar" class="btn btn-red btn-lg" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title=""  type="button"
                                data-original-title="ASIGNAR PRODUCTOS">
                            <span class="fa fa-share fa-3x"></span>
                        </button>
                    </div>
                    <div id="rBusqueda" class="hide">
                        <fieldset>
                            ...
                            <div class="col-md-2">
                                ...
                                <button id="btnBuscar" class="btn btn-emerald btn-lg" 
                                        data-toggle="tooltip" 
                                        data-placement="top" 
                                        title=""  type="button"
...
<div class="modal fade" id="mdlModificar" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="mdlPrecioXProveedor" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="mdlEditarPrecioXProveedor" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="mdlProductosXProveedor" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
