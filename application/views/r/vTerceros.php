            ...
            <div class="panel-body">
                <fieldset>
                    <div id="btnAccions" align="center" class="col-md-12">
                        <fieldset> 
                            <button id="btnPago" class="btn btn3d  btn-info  btn-lg"  data-toggle="tooltip" data-placement="top" title="" data-original-title="NUEVO PAGO">
                                <span class="fa fa-plus fa-5x"></span></button>            
                            <button id="btnEditarCuentas" class="btn btn3d btn-success btn-lg" data-toggle="tooltip" data-placement="top" 
                                    title="" data-original-title="MODIFICAR CUENTA"><span class="fa fa-pencil fa-5x"></span></button>

                            <button id="btnRefrescarCuentas" class="btn btn3d btn-warning btn-lg" data-toggle="tooltip" data-placement="top" 
                                    title="" data-original-title="REFRESCAR CUENTAS"  ><span class="fa fa-refresh fa-5x"></span></button>

                            <button id="btnRefrescarCuentas" class="btn btn3d btn-indigo btn-lg" data-toggle="tooltip" data-placement="top" 
    ...
    <div class="modal-dialog modal-lg fullscreen" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer"> 
                ...
                <button id="btnGuardar" name="btnGuardar" type="button" class="btn btn-success btn-3x" data-toggle="tooltip" data-placement="top" title="" data-original-title="GUARDAR" ><span class="fa fa-check fa-5x"></span></button> 
            </div>
        </div>
    </div>
</div>
