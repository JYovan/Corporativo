                    ...
                    <div id="btnAccions" align="center" class="col-md-12">
                        <fieldset>
                            <span  data-toggle="modal" data-easein="swoopIn" data-target="#mdlNuevaCuenta" > 
                                <button id="btnAgregarTerceros" class="btn btn3d   btn-info "  data-toggle="tooltip" data-placement="top" title="" data-original-title="NUEVA CUENTA">
                                    <span class="fa fa-plus fa-4x"></span></button>
                            </span>
                            <button id="btnEditarCuentas" class="btn btn3d btn-success" data-toggle="tooltip" data-placement="top" 
                                    title="" data-original-title="MODIFICAR CUENTA"><span class="fa fa-pencil fa-4x"></span></button>

                            <button id="btnRefrescarCuentas" class="btn btn3d btn- btn-warning" data-toggle="tooltip" data-placement="top" 
                                    title="" data-original-title="REFRESCAR CUENTAS"  ><span class="fa fa-refresh fa-4x"></span></button>

                            <button id="btnRefrescarCuentas" class="btn btn3d btn-indigo" data-toggle="tooltip" data-placement="top" 
                                    title="" data-original-title="ACTUALIZAR SALDO"  ><i class="fa fa-money fa-4x"></i>  
                            </button>
                        </fieldset>
                    </div>  
    ...
    <div class="modal-dialog modal-lg fullscreen" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer"> 
                ...
                <button id="btnGuardar" name="btnGuardar" type="button" class="btn btn-success btn-3x" data-toggle="tooltip" data-placement="top" title="" data-original-title="GUARDAR" ><span class="fa fa-check fa-3x"></span></button> 
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog fullscreen" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="btnUpdate" class="btn btn-yellow"><span class="fa fa-refresh fa-3x"></span></button> 
            </div>
        </div>
    </div>
</div>
...
//                console.log(data);
   ...
   <button type="button" class="close" data-dismiss="alert">&times;</button>\n\
    ...
    function onRefresh() {
        ...
        prepareCall.add(getOptions('index.php/ctrlContratos/getDirectorio', "#mdlNuevaCuenta #Empresa", false, {}));
        prepareCall.add(getOptions('index.php/ctrlContratos/getDirectorio', "#mdlModificarCuenta #Empresa", false, {}));
