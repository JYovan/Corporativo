...
<?php echo form_open_multipart('controlador/SS_13'); ?> 
                    ...
                    <tr>
                        <td bgcolor="#ff6600" align="center">
                            <strong style="color:#FFF">
                                Cancelar número patronal de identificación electrónica (NPIE) y certificado digital
                            </strong>
                        </td>
                    </tr>  
                    <tr>
                        ...
                        <td  bgcolor="#99A79A">
                            <div class="col-xs-12 col-sm-12">
                                <label for="DatosL" class="control-label">
                                    Estado del trámite de cancelar número patronal de identificación electrónica (NPIE) y certificado digital
                                </label><br>		
                            </div>
                        </td>
                    </tr>
