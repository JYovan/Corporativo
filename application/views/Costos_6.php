                    ...
                    <tr>
                        <td>
                            <div class="col-md-2 col-xs-12" style="color:#ffffff">
                                <strong style="color:#ff6600">Administración</strong>
                            </div>
                            <div class="col-md-2 col-xs-12" style="color:#ffffff">
                                <strong style="color:#ff6600">Número de responsables</strong>
                            </div>
                            <div class="col-md-2 col-xs-12" style="color:#ffffff" align="center">
                                <strong style="color:#ff6600">Días de entrega</strong>
                            </div>
                            <div class="col-md-2 col-xs-12" style="color:#ffffff" align="center">
                                <strong style="color:#ff6600">Pago por día</strong align="center">
                            </div>
                            <div class="col-md-2 col-xs-12" style="color:#ffffff" align="center">
