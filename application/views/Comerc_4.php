                    ...
                    <tr>
                        <td>
                            <div class="col-xs-12 col-sm-12">
                                <blockquote> 
                                    <br>
                                    <input type="radio" value="COM_41" name="COMID" id="COMID" required/>
                                    Registro de pagos por concepto de compra de vivienda
                                    <br>
                                    <input type="radio" value="COM_42" name="COMID" id="COMID" required/>
                                    Registro de cancelación de la compraventa de vivienda    
                                    <br>
                                </blockquote>   
                            </div>
                        </td>
