...
<?php echo form_open_multipart('controlador/CDIOT'); ?> 
        ...
        <tr>
            <td>
                <table width="100%">    
                    <tr>
                        <td bgcolor="#ff6600">
                            <strong style="color:#FFF">Declaración DIOT</strong>
                        </td>
                    </tr>
                    <tr>
                        <td>
...
<?php } ?>
                    ...
                    <tr>
                        <td>
                            <div class="col-xs-12 col-sm-12">
                                <div class="col-xs-3 col-sm-3">
                                    <label for="ObservacionesBG1" class="control-label">Observaciones (Folio)</label><br>
                                </div>
                                <div class="col-xs-6 col-sm-6">
                        ...
                        <td  bgcolor="#99A79A">
                            <div class="col-xs-12 col-sm-12">
                                <label for="DatosL" class="control-label">
                                    Estado de la declaración DIOT </label><br>		
                            </div>
                        </td>
                    </tr>
                    <tr>
