...
<?php echo form_open_multipart('controlador/RevExpediente'); ?> 
                    ...
                    <tr>
                        <td bgcolor="#ff6600" align="center">
                            <div class="col-xs-12 col-sm-12">
                                <strong style="color:#FFF">Expediente</strong>
                            </div>
                        </td>
                    </tr>
                    <tr>
...
<?php } ?>
                    ...
                    <tr>
                        <td>
                            <div class="col-xs-12 col-sm-12">
                                <button class="btn btn-lg btn-primary btn-block" type="submit" id="user" name="user" value="<?php echo $indice; ?>" >Evaluar</button>
                            </div>
                        </td>
                    </tr>
                </table>  
