...
<?php echo form_open_multipart('controlador/EBalanceCP'); ?> 
...
<?php } ?>
                    ...
                    <tr>
                        <td>
                            <div class="col-xs-12 col-sm-12">
                                <div class="col-xs-6 col-sm-6">
                                    <label for="Documento" class="control-label">Balanza en proceso</label>
                                </div>
                                <div class="col-xs-3 col-sm-3">
                    ...
                    <tr>
                        <td>
                            <div class="col-xs-12 col-sm-12">
                                <div class="col-xs-6 col-sm-6">
                                    <label for="Documento" class="control-label">Balanza concluído </label>
                                </div>
                                <div class="col-xs-3 col-sm-3">
                    ...
                    <tr>
                        <td>
                            <div class="col-xs-12 col-sm-12">
                                <div class="col-xs-6 col-sm-6">
                                    <label for="Documento" class="control-label">Balanza  entregado al área fiscal</label>
                                </div>
                                <div class="col-xs-3 col-sm-3">
                    ...
                    <tr>
                        <td>
                            <div class="col-xs-12 col-sm-12">
                                <div class="col-xs-6 col-sm-6">
                                    <label for="Documento" class="control-label">Balanza  notificado al cliente</label>
                                </div>
                                <div class="col-xs-3 col-sm-3">
                    ...
                    <tr>
                        <td>
                            <div class="col-xs-12 col-sm-12">
                                <div class="col-xs-6 col-sm-6">
                                    <label for="Documento" class="control-label">Balanza  integrado al expediente mensual del cliente</label>
                                </div>
                                <div class="col-xs-3 col-sm-3">
...
<script>
    cli.config.InformacionBalanceCP();
</script>
