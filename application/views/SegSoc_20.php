...
<?php echo form_open_multipart('controlador/SS_20'); ?> 
                        ...
                        <td  bgcolor="#99A79A">
                            <div class="col-xs-12 col-sm-12">
                                <label for="DatosL" class="control-label">
                                    Estado del trámite de asesorías en trámites IMSS
                                </label><br>		
                            </div>
                        </td>
                    </tr>
                        ...
                        <td>
                            <div class="col-xs-12 col-sm-12">
                                <div class="col-xs-4 col-sm-4">
                                    <label for="1" class="control-label">Asesoría:</label><br>
                                </div>
                                <div class="col-xs-8 col-sm-8">
                                    <input  style="text-transform:uppercase" onkeyup="javascript:this.value = this.value.toUpperCase()" class="form-control" type="text" name="Asesoria" id="Asesoria" >		
                                </div>
                            </div>
                        </td>
                    </tr>
                        ...
                        <td>
                            <div class="col-xs-12 col-sm-12">
                                <blockquote>
                                    ...
                                    Notificado al titular de la empresa
                                    <br>
                                    <input type="radio" value="5" name="Estatus" id="Estatus" required/>
                                    Integrado al expediente de la empresa
                                    <br>
                                </blockquote>   
                            </div>
                        </td>
